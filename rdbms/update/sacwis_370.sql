...
-- Add 1 columns to PERSON/PERSON_ENC to support Adoption Enhancements 

alter table caps.person_enc add ind_adopt_finalized varchar2(1);
...
CONSTRAINT FK_EXCHANGE_CHILD_PERSON FOREIGN KEY (ID_PERSON)
   REFERENCES CAPS.PERSON_ENC(ID_PERSON) ) tablespace data01;
...
constraint fk_sibling_person foreign key (id_person)
   references caps.person_enc(id_person) enable) tablespace data01;
...
insert into caps.schema_version (id_schema_version, application_version, comments)
                        values (371, 'SacwisRev2', 'Release 2.6 - DBCR 9954 Adoption Enhancements');
commit;
