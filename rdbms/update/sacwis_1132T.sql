...
--Update  triggers on PERSON table and PERSON view. Also, replace PERSON view to reflect the addition of the new column IND_IVE_PRIOR_ADOPTION.
...
BEFORE INSERT
ON CAPS.PERSON REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
DECLARE
  --------------------------------------------------------------------------------------
