...
(
  ...
  NBR_FFY NUMBER(4),
  ID_CHILD NUMBER(16) NOT NULL REFERENCES CAPS.PERSON_ENC(ID_PERSON),
  DT_CHILD_DOB DATE,
  ...
  ID_AC_SIBLING NUMBER(16) REFERENCES CAPS.PERSON_ENC(ID_PERSON),
...
(
      ...
      DT_LAST_UPDATE DATE NOT NULL,
      ID_PERSON NUMBER(16) NOT NULL REFERENCES CAPS.PERSON_ENC(ID_PERSON),
...
'/financials/AdoptionAsstnc/displayAAFundingSummary',0,'0',
'0','0',null
);
