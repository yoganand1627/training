...
ALTER TABLE CAPS.FCCP_CHILD_CBX ADD CD_CBX_CODE_TYPE VARCHAR2(8)     NULL
;
...
;
ALTER TABLE CAPS.CAPS_RESOURCE RENAME TO CAPS_RESOU_12212006212255000
;
...
(
    ...
    CD_RSRC_FA_HOME_TYPE_1  VARCHAR2(3)       NULL,
    CD_RSRC_FA_HOME_TYPE_2  VARCHAR2(3)       NULL,
    CD_RSRC_FA_HOME_TYPE_3  VARCHAR2(3)       NULL,
    CD_RSRC_FA_HOME_TYPE_4  VARCHAR2(3)       NULL,
    CD_RSRC_FA_HOME_TYPE_5  VARCHAR2(3)       NULL,
    CD_RSRC_FA_HOME_TYPE_6  VARCHAR2(3)       NULL,
    CD_RSRC_FA_HOME_TYPE_7  VARCHAR2(3)       NULL,
...
;
ALTER TABLE CAPS.RESOURCE_HISTORY RENAME TO RESOURCE_H_12212006212256000
;
...
(
    ...
    CD_RSHS_FA_HOME_TYPE1   VARCHAR2(3)       NULL,
    CD_RSHS_FA_HOME_TYPE2   VARCHAR2(3)       NULL,
    CD_RSHS_FA_HOME_TYPE3   VARCHAR2(3)       NULL,
    CD_RSHS_FA_HOME_TYPE4   VARCHAR2(3)       NULL,
    CD_RSHS_FA_HOME_TYPE5   VARCHAR2(3)       NULL,
    CD_RSHS_FA_HOME_TYPE6   VARCHAR2(3)       NULL,
    CD_RSHS_FA_HOME_TYPE7   VARCHAR2(3)       NULL,
...
;
ALTER TABLE CAPS.RESOURCE_HISTORY_AUDIT RENAME TO RESOURCE_H_12212006212257000
;
...
INSERT INTO CAPS.CAPS_RESOURCE(
                        ...
                        SELECT 
                               ...
                               IND_PREV_FAM_STDY_RQSTD,
                               RSRC_OTH_SPC_CERTF
                          FROM CAPS.CAPS_RESOU_12212006212255000 
;
COMMIT
;
...
INSERT INTO CAPS.RESOURCE_HISTORY(
                           ...
                           SELECT 
                                  ...
                                  IND_PREV_FAM_STDY_RQSTD,
                                  RSRC_OTH_SPC_CERTF
                             FROM CAPS.RESOURCE_H_12212006212256000 
;
COMMIT
;
...
INSERT INTO CAPS.RESOURCE_HISTORY_AUDIT(
                                 ...
                                 SELECT 
                                        ...
                                        IND_PREV_FAM_STDY_RQSTD,
                                        RSRC_OTH_SPC_CERTF
                                   FROM CAPS.RESOURCE_H_12212006212257000 
;
COMMIT
;
...
DROP TABLE CAPS.RESOURCE_H_12212006212256000;
DROP TABLE CAPS.RESOURCE_H_12212006212257000;
...
-- change 281 R2
update CAPS.TASK set txt_task_decode='Team Meetings/Reviews' where cd_task = '8680'; 
update CAPS.TASK set txt_task_decode='Team Meetings/Reviews' where cd_task = '3180';

-- change 282 R2
INSERT INTO CAPS.MESSAGE (NBR_MESSAGE,TXT_MESSAGE_NAME,TXT_MESSAGE,CD_SOURCE,CD_PRESENTATION) 
  VALUES (60089,'MSG_REF_ASST_DATE','The Referral Date must be on or before the Assessment Complete Date.',500,700); 

INSERT INTO CAPS.MESSAGE (NBR_MESSAGE,TXT_MESSAGE_NAME,TXT_MESSAGE,CD_SOURCE,CD_PRESENTATION) 
  VALUES (60090,'MSG_AGENCY_NAME','Agency Name is required if any other CCFA information has been completed.',500,700);
  
-- change 283 R2
INSERT INTO CAPS.METAPHOR (ID_TAB,TXT_TAB_URL,TXT_TAB_CONSTANT,TXT_TAB ) 
     VALUES (1480,'/subcare/NeedsAndOutcomes/displayNeedsAndOutcomes','NEEDS_AND_OUTCOMES','Needs and Outcomes');

--change 284 R2
insert into caps.codes_tables values ('CSCHTYPE','COM','Combined',null,to_date('12/22/2006','MM/DD/YYYY')); 
insert into caps.codes_tables values ('CSCHTYPE','DAY','Day Care',null,to_date('12/22/2006','MM/DD/YYYY')); 
insert into caps.codes_tables values ('CSCHTYPE','ELM','Elementary',null,to_date('12/22/2006','MM/DD/YYYY')); 
insert into caps.codes_tables values ('CSCHTYPE','HSC','High School',null,to_date('12/22/2006','MM/DD/YYYY')); 
insert into caps.codes_tables values ('CSCHTYPE','MID','Middle/Jr. High',null,to_date('12/22/2006','MM/DD/YYYY')); 
insert into caps.codes_tables values ('CSCHTYPE','ONS','On-Site',null,to_date('12/22/2006','MM/DD/YYYY')); 
insert into caps.codes_tables values ('CSCHTYPE','PRE','Pre-K/Head Start',null,to_date('12/22/2006','MM/DD/YYYY'));
insert into caps.codes_tables values ('CSCHTYPE','XNO','None',null,to_date('12/22/2006','MM/DD/YYYY')); 

update caps.CODES_TABLES set DT_END = to_date('01/01/2006','MM/DD/YYYY') where CODE = 'B' and CODE_TYPE = 'CAMPTYPE'; 
update caps.CODES_TABLES set DT_END = to_date('01/01/2006','MM/DD/YYYY') where CODE = 'E' and CODE_TYPE = 'CAMPTYPE'; 
update caps.CODES_TABLES set DT_END = to_date('01/01/2006','MM/DD/YYYY') where CODE = 'M' and CODE_TYPE = 'CAMPTYPE'; 
update caps.CODES_TABLES set DT_END = to_date('01/01/2006','MM/DD/YYYY') where CODE = 'S' and CODE_TYPE = 'CAMPTYPE'; 
update caps.CODES_TABLES set DT_END = to_date('01/01/2006','MM/DD/YYYY') where CODE = 'U' and CODE_TYPE = 'CAMPTYPE'; 
update caps.CODES_TABLES set DT_END = to_date('01/01/2006','MM/DD/YYYY') where CODE = 'X' and CODE_TYPE = 'CAMPTYPE'; 

insert into caps.schema_version (id_schema_version, application_version, comments)
                         values (120, 'SacwisRev2', 'static updates, modify columns in resource tables');
