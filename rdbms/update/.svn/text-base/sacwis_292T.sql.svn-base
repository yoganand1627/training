...
CREATE TABLE CAPS.AFCARS_HISTORY
(
...
NOCACHE
;
COMMENT ON TABLE CAPS.AFCARS_HISTORY IS
'Table used to house additional data used by AFCARS reporting.'
;
COMMENT ON COLUMN CAPS.AFCARS_HISTORY.DT_LAST_UPDATE IS
'Date of insert or last update'
;
GRANT DELETE ON CAPS.AFCARS_HISTORY TO CAPSBAT;
GRANT INSERT ON CAPS.AFCARS_HISTORY TO CAPSBAT;
GRANT SELECT ON CAPS.AFCARS_HISTORY TO CAPSBAT;
GRANT UPDATE ON CAPS.AFCARS_HISTORY TO CAPSBAT;
GRANT DELETE ON CAPS.AFCARS_HISTORY TO CAPSON;
GRANT INSERT ON CAPS.AFCARS_HISTORY TO CAPSON;
GRANT SELECT ON CAPS.AFCARS_HISTORY TO CAPSON;
GRANT UPDATE ON CAPS.AFCARS_HISTORY TO CAPSON;
GRANT SELECT ON CAPS.AFCARS_HISTORY TO OPERATOR;

ALTER TABLE CAPS.AFCARS_HISTORY 
