...
comment on column CAPS.PARENT_CONTACT_RULE.ID_PERSON is 'Records person id of the person who the parent contact rule is for. Foreign key to PERSON_ENC.ID_PERSON' ;
...
comment on column CAPS.CHILD_CONTACT_RULE.ID_PERSON is 'Records person id of the person who the child contact rule is for. Foreign key to PERSON_ENC.ID_PERSON' ;
