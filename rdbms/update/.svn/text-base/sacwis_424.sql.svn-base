...
CREATE OR REPLACE VIEW CAPS.AFCARS_VIEW ("STATE", "REPORT_DATE", "DT_LAST_UPDATE", 
...
grant select on CAPS.AFCARS_VIEW to operator;
grant select,update,insert,delete on CAPS.AFCARS_VIEW to capson,capsbat,ops$datafix;

insert into caps.schema_version (id_schema_version, application_version, comments)
                        values (425, 'SacwisRev2', 'Release 2.6 - DBCR 12090');
