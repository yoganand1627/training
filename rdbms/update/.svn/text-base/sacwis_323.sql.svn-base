...
-- change STGAP00008875 
-- for defect STGAP00007981, updates sacwis_307.sql 
UPDATE CAPS.SECURITY_CLASS 
SET TXT_SECURITY_CLASS_PROFIL = TXT_SECURITY_CLASS_PROFIL || '00'
WHERE length(TXT_SECURITY_CLASS_PROFIL) = 86;

-- change STGAP00008878
INSERT INTO CAPS.CODES_TABLES (code_type, code, DECODE, dt_last_update) VALUES ('CSECATTR', 'PF', 'Associate ORS Facilities to SHINES Resources', SYSDATE);
...
insert into caps.schema_version (id_schema_version, application_version, comments)
                        values (324, 'SacwisRev2', 'static security table updates');                        
commit;
