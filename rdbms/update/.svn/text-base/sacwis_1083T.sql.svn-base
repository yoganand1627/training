...
set TXT_TAB_URL = '/financials/UASProgramCodeMaintenance/displayUASProgramCodeMaintenance';
...
CONSTRAINT FK_UAS_MTNT_PERSON_UPDATE FOREIGN KEY (ID_PERSON_LAST_UPDATE) REFERENCES CAPS.PERSON);
