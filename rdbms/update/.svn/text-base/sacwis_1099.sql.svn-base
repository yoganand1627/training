--STGAP00017084 - Release(5.0) Per SMS109554 - Add column to client_outbound tabl

--Per ITSM 37804/ SMS109554 add column to table sacwisifc.client_outbound

alter table sacwisifc.client_outbound_enc add ID_PERSON_CLOSED NUMBER(16,0);

comment on column SACWISIFC.CLIENT_OUTBOUND_ENC.ID_PERSON_CLOSED is 'Shines id of closed person in merge';
...
ID_CLIENT_OUTBOUND=:NEW.ID_CLIENT_OUTBOUND,
 ...
 ID_PERSON_CLOSED= :NEW.ID_PERSON_CLOSED
WHERE ID_CLIENT_OUTBOUND=:OLD.ID_CLIENT_OUTBOUND;
END;
/
insert into caps.schema_version(id_schema_version,application_version,comments)
            values (1100, 'SacwisRev5', 'Release 5.0 - DBCR 17084');
