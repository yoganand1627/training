--STGAP00013107 - Database Change Request for Case Review Page

--Note:  no imapct to ado model


--New table - CASE_REVIEW_CATEG_LOOKUP

create table caps.CASE_REVIEW_CATEG_LOOKUP
(cd_category varchar2(10) not null,
dt_last_update date not null,
txt_category varchar2(50),
nbr_category_order number(3),
constraint pk_CASE_REVIEW_CATEG_LOOKUP PRIMARY KEY (cd_category) using index tablespace index01)
tablespace data01;

comment on table caps.CASE_REVIEW_CATEG_LOOKUP is 'Static table to store Category of the questions';
comment on column caps.CASE_REVIEW_CATEG_LOOKUP.cd_category is 'Code Category';
comment on column caps.CASE_REVIEW_CATEG_LOOKUP.dt_last_update is 'SYstem Date';
comment on column caps.CASE_REVIEW_CATEG_LOOKUP.txt_category is 'Text for the category';
comment on column caps.CASE_REVIEW_CATEG_LOOKUP.nbr_category_order is 'Order of the Category to display on the page';

grant select,update,insert,delete on CAPS.CASE_REVIEW_CATEG_LOOKUP to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_CATEG_LOOKUP to operator;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_CATEG_LOOKUP 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_CATEG_LOOKUP
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_CATEG_LOOKUP
BEFORE INSERT
ON CAPS.CASE_REVIEW_CATEG_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
--- New table CASE_REVIEW_ITEM_LOOKUP

create table caps.CASE_REVIEW_ITEM_LOOKUP
(cd_item varchar2(10) not null,
dt_last_update date not null,
txt_item varchar2(50),
nbr_item_order number(3),
cd_category varchar2(10),
constraint pk_CASE_REVIEW_ITEM_LOOKUP PRIMARY KEY (cd_item) using index tablespace index01)
tablespace data01;

comment on table caps.CASE_REVIEW_ITEM_LOOKUP is 'Static table to store item of the questions';
comment on column caps.CASE_REVIEW_ITEM_LOOKUP.cd_item is 'Code item';
comment on column caps.CASE_REVIEW_ITEM_LOOKUP.dt_last_update is 'SYstem Date';
comment on column caps.CASE_REVIEW_ITEM_LOOKUP.txt_item is 'Text for the item';
comment on column caps.CASE_REVIEW_ITEM_LOOKUP.nbr_item_order is 'Order of the item to display on the page';
comment on column caps.CASE_REVIEW_ITEM_LOOKUP.cd_category is 'Code Category';

grant select,update,insert,delete on CAPS.CASE_REVIEW_ITEM_LOOKUP to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_ITEM_LOOKUP to operator;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_ITEM_LOOKUP 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_ITEM_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_ITEM_LOOKUP
BEFORE INSERT
ON CAPS.CASE_REVIEW_ITEM_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
--  New table CASE_REVIEW_QUES_LOOKUP

create table caps.CASE_REVIEW_QUES_LOOKUP
(
CD_QUESTION varchar2(10) not null,
DT_LAST_UPDATE date not null,
TXT_QUESTION varchar2(1000),
NBR_QUESTION_ORDER number(3),
CD_ITEM varchar2(10),
CD_SURVEY_QUESTION_TYPE  varchar2(10),
IND_QUESTION_TYPE varchar2(1),
IND_CBX varchar2(1),
TXT_QUES_HELP varchar2(1000),
constraint pk_CASE_REVIEW_QUES_LOOKUP PRIMARY KEY (cd_question) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_QUES_LOOKUP is 'Static table to store Questions';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.CD_QUESTION is 'Code Question';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.DT_LAST_UPDATE is 'System Date';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.TXT_QUESTION is 'Text for the Question';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.NBR_QUESTION_ORDER is 'Order of the Question to display on the page';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.CD_ITEM is 'Code Item';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.CD_SURVEY_QUESTION_TYPE is 'Question Type of the Survey i.e. Yes No N/A type etc';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.IND_QUESTION_TYPE is 'Type of the Question if Main, Sub or Decision Question';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.IND_CBX is 'If that Question has  checkboxes';
comment on column CAPS.CASE_REVIEW_QUES_LOOKUP.TXT_QUES_HELP is 'Help on the Question';

grant select,update,insert,delete on CAPS.CASE_REVIEW_QUES_LOOKUP to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_QUES_LOOKUP to operator;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_QUES_LOOKUP 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_QUES_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_QUES_LOOKUP
BEFORE INSERT
ON CAPS.CASE_REVIEW_QUES_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
---  New Table CASE_REVIEW_CBX_LOOKUP

create table caps.CASE_REVIEW_CBX_LOOKUP
(
CD_QUESTION VARCHAR2(10) not null,
DT_LAST_UPDATE DATE not null,
TXT_CBX_QUESTION VARCHAR2(100) not null,
CD_CBX_QUESTION	VARCHAR2(10) not null,
constraint pk_CASE_REVIEW_CBX_LOOKUP PRIMARY KEY (cd_cbx_question) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_CBX_LOOKUP is 'Static table to store Checkboxes of the questions';
comment on column caps.CASE_REVIEW_CBX_LOOKUP.CD_QUESTION is 'Code Question';
comment on column caps.CASE_REVIEW_CBX_LOOKUP.DT_LAST_UPDATE is 'System Date';
comment on column caps.CASE_REVIEW_CBX_LOOKUP.TXT_CBX_QUESTION is 'Text for the checkbox';
comment on column caps.CASE_REVIEW_CBX_LOOKUP.CD_CBX_QUESTION is 'Code Checkbox';


grant select,update,insert,delete on CAPS.CASE_REVIEW_CBX_LOOKUP to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_CBX_LOOKUP to operator;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_CBX_LOOKUP 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_CBX_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_CBX_LOOKUP
BEFORE INSERT
ON CAPS.CASE_REVIEW_CBX_LOOKUP
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
-- New Table CASE_REVIEW

create table caps.CASE_REVIEW
(
ID_CSR_EVENT number(16) not null,
DT_LAST_UPDATE DATE not null,
ID_STAGE number(16) not null,
ID_CASE number(16) not null,
DT_REVIEW DATE,
IND_SAMPLE VARCHAR2 (1),
IND_COMPLETE VARCHAR2 (1),
DT_STAFFED_WITH_WORKER DATE,
DT_CORRECTION_DUE DATE,
DT_CORRECTION_COMPLETE DATE,
TXT_SUMMARY_COMMENT VARCHAR2 (500),
REVIEW_PERIOD VARCHAR2 (20),
ID_REVIEWER_PERSON VARCHAR2 (16),
constraint pk_CASE_REVIEW PRIMARY KEY (ID_CSR_EVENT) using index tablespace index01,
CONSTRAINT FK_CASE_REVIEW FOREIGN KEY (ID_CSR_EVENT) 
   REFERENCES CAPS.EVENT(ID_EVENT) ENABLE)
tablespace data01;

create index CAPS.IND_CASE_REVIEW_1 on CAPS.CASE_REVIEW(id_stage,dt_review) tablespace index01;
create index CAPS.IND_CASE_REVIEW_2 on CAPS.CASE_REVIEW(id_case,dt_review) tablespace index01;

comment on table CAPS.CASE_REVIEW is 'Table to save Case Review Page data';
comment on column CAPS.CASE_REVIEW.ID_CSR_EVENT is 'Id Event';
comment on column CAPS.CASE_REVIEW.DT_LAST_UPDATE is 'System Date';
comment on column CAPS.CASE_REVIEW.ID_STAGE is 'Id Stage';
comment on column CAPS.CASE_REVIEW.ID_CASE is 'Id Case';
comment on column CAPS.CASE_REVIEW.DT_REVIEW is 'Review Date';
comment on column CAPS.CASE_REVIEW.IND_SAMPLE is 'If it''s a sample review';
comment on column CAPS.CASE_REVIEW.IND_COMPLETE is 'If the Review is complete';
comment on column CAPS.CASE_REVIEW.DT_STAFFED_WITH_WORKER is 'Date staffed with worker';
comment on column CAPS.CASE_REVIEW.DT_CORRECTION_DUE is 'Date corrections are due';
comment on column CAPS.CASE_REVIEW.DT_CORRECTION_COMPLETE is 'Date Correction are completed';
comment on column CAPS.CASE_REVIEW.TXT_SUMMARY_COMMENT is 'Comments';
comment on column CAPS.CASE_REVIEW.REVIEW_PERIOD is 'Review period';
comment on column CAPS.CASE_REVIEW.ID_REVIEWER_PERSON is 'Id Person who created the Case Review';

grant select,update,insert,delete on CAPS.CASE_REVIEW to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW to operator;


/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW 
BEFORE UPDATE
ON CAPS.CASE_REVIEW
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW
BEFORE INSERT
ON CAPS.CASE_REVIEW
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
--- New table CASE_REVIEW_CATEG

create table caps.CASE_REVIEW_CATEG
(
ID_CASE_REVIEW_CATEG number(16) not null,
DT_LAST_UPDATE DATE not null,
ID_EVENT number(16) not null,
ID_STAGE number(16) not null,
CD_CATEGORY VARCHAR2 (10),
constraint pk_CASE_REVIEW_CATEG PRIMARY KEY (ID_CASE_REVIEW_CATEG) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_CATEG is 'Table to save Category of the questions for the particular Case Review';
comment on column CAPS.CASE_REVIEW_CATEG.ID_CASE_REVIEW_CATEG is 'Code Question';
comment on column CAPS.CASE_REVIEW_CATEG.DT_LAST_UPDATE is 'System Date';
comment on column CAPS.CASE_REVIEW_CATEG.ID_EVENT is 'Id Event';
comment on column CAPS.CASE_REVIEW_CATEG.ID_STAGE is 'Id Stage';
comment on column CAPS.CASE_REVIEW_CATEG.CD_CATEGORY is 'Code Category';


create index CAPS.IND_CASE_REVIEW_CATEG_1 on CAPS.CASE_REVIEW_CATEG(id_stage) tablespace index01;
create index CAPS.IND_CASE_REVIEW_CATEG_2 on CAPS.CASE_REVIEW_CATEG(id_event) tablespace index01;


grant select,update,insert,delete on CAPS.CASE_REVIEW_CATEG to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_CATEG to operator;

CREATE SEQUENCE  CAPS.SEQ_CASE_REVIEW_CATEG  NOMINVALUE NOMAXVALUE INCREMENT
BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;

grant select on CAPS.SEQ_CASE_REVIEW_CATEG  to capsbat,capson,ops$datafix;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_CATEG 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_CATEG
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_CATEG
BEFORE INSERT
ON CAPS.CASE_REVIEW_CATEG
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
BEGIN
:NEW.DT_LAST_UPDATE := sysdate;
  if :NEW.ID_CASE_REVIEW_CATEG=0 then
    SELECT SEQ_CASE_REVIEW_CATEG.NEXTVAL INTO dummy FROM DUAL;
    :NEW.ID_CASE_REVIEW_CATEG := dummy;
  end if;
END;
/

--- New Table CASE_REVIEW_ITEM

create table caps.CASE_REVIEW_ITEM
(
ID_CASE_REVIEW_ITEM number(16) not null,
DT_LAST_UPDATE DATE not null,
ID_CASE_REVIEW_CATEG number(16) not null,
ID_EVENT number(16) not null,
ID_STAGE number(16) not null,
...
constraint pk_CASE_REVIEW_ITEM PRIMARY KEY (ID_CASE_REVIEW_ITEM) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_ITEM is 'Table to save Items of the questions for the particular Case Review';
comment on column CAPS.CASE_REVIEW_ITEM.CD_ITEM is 'Code Item';
comment on column CAPS.CASE_REVIEW_ITEM.TXT_COMMENTS is 'Comments';


create index CAPS.IND_CASE_REVIEW_ITEM_1 on CAPS.CASE_REVIEW_ITEM(id_stage) tablespace index01;
create index CAPS.IND_CASE_REVIEW_ITEM_2 on CAPS.CASE_REVIEW_ITEM(id_event) tablespace index01;


grant select,update,insert,delete on CAPS.CASE_REVIEW_ITEM to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_ITEM to operator;

CREATE SEQUENCE  CAPS.SEQ_CASE_REVIEW_ITEM  NOMINVALUE NOMAXVALUE INCREMENT
BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;

grant select on CAPS.SEQ_CASE_REVIEW_ITEM  to capsbat,capson,ops$datafix;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_ITEM 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_ITEM
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_ITEM
BEFORE INSERT
ON CAPS.CASE_REVIEW_ITEM
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
BEGIN
:NEW.DT_LAST_UPDATE := sysdate;
  if :NEW.ID_CASE_REVIEW_ITEM=0 then
    SELECT SEQ_CASE_REVIEW_ITEM.NEXTVAL INTO dummy FROM DUAL;
    :NEW.ID_CASE_REVIEW_ITEM := dummy;
  end if;
END;
/

-- New Table CASE_REVIEW_QUES_RESPONSE

create table caps.CASE_REVIEW_QUES_RESPONSE
(
ID_CASE_REVIEW_QUES_RESPONSE number(16) not null,
DT_LAST_UPDATE DATE not null,
ID_CASE_REVIEW_CATEG number(16) not null,
ID_CASE_REVIEW_ITEM number(16) not null,
ID_EVENT number(16) not null,
ID_STAGE number(16) not null,
CD_QUESTION VARCHAR2 (10),
CD_QUES_RESPONSE VARCHAR2(1),
constraint pk_CASE_REVIEW_QUES_RESPONSE PRIMARY KEY (ID_CASE_REVIEW_QUES_RESPONSE) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_QUES_RESPONSE is 'Table to save Questions with responses for the particular Case Review';
comment on column CAPS.CASE_REVIEW_QUES_RESPONSE.CD_QUESTION is 'Code Question';
comment on column CAPS.CASE_REVIEW_QUES_RESPONSE.CD_QUES_RESPONSE is 'QuestionResponse';


create index CAPS.IND_CASE_REVIEW_QUES_RESP_1 on CAPS.CASE_REVIEW_QUES_RESPONSE(id_stage) tablespace index01;
create index CAPS.IND_CASE_REVIEW_QUES_RESP_2 on CAPS.CASE_REVIEW_QUES_RESPONSE(id_event) tablespace index01;


grant select,update,insert,delete on CAPS.CASE_REVIEW_QUES_RESPONSE to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_QUES_RESPONSE to operator;

CREATE SEQUENCE  CAPS.SEQ_CASE_REVIEW_QUES_RESP  NOMINVALUE NOMAXVALUE INCREMENT
BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;

grant select on CAPS.SEQ_CASE_REVIEW_QUES_RESP  to capsbat,capson,ops$datafix;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_QUES_RESPONSE 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_QUES_RESPONSE
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_QUES_RESPONSE
BEFORE INSERT
ON CAPS.CASE_REVIEW_QUES_RESPONSE
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
BEGIN
:NEW.DT_LAST_UPDATE := sysdate;
  if :NEW.ID_CASE_REVIEW_QUES_RESPONSE=0 then
    SELECT SEQ_CASE_REVIEW_QUES_RESP.NEXTVAL INTO dummy FROM DUAL;
    :NEW.ID_CASE_REVIEW_QUES_RESPONSE := dummy;
  end if;
END;
/

-- New Table CASE_REVIEW_CBX_RESPONSE

create table caps.CASE_REVIEW_CBX_RESPONSE
(
ID_CASE_REVIEW_CBX_RESPONSE number(16) not null,
DT_LAST_UPDATE DATE not null,
ID_EVENT number(16) not null,
CD_QUESTION VARCHAR2 (10),
CD_CBX_QUESTION VARCHAR2(10),
constraint pk_CASE_REVIEW_CBX_RESPONSE PRIMARY KEY (ID_CASE_REVIEW_CBX_RESPONSE) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_CBX_RESPONSE is 'Table to save checked checkboxes for a particular question and case review';
comment on column CAPS.CASE_REVIEW_CBX_RESPONSE.CD_QUESTION is 'Code Question';
comment on column CAPS.CASE_REVIEW_CBX_RESPONSE.CD_CBX_QUESTION is 'Code Checkbox';


create index CAPS.IND_CASE_REVIEW_CBX_RESPONSE_2 on CAPS.CASE_REVIEW_CBX_RESPONSE(id_event) tablespace index01;


grant select,update,insert,delete on CAPS.CASE_REVIEW_CBX_RESPONSE to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_CBX_RESPONSE to operator;

CREATE SEQUENCE  CAPS.SEQ_CASE_REVIEW_CBX_RESPONSE  NOMINVALUE NOMAXVALUE INCREMENT
BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;

grant select on CAPS.SEQ_CASE_REVIEW_CBX_RESPONSE  to capsbat,capson,ops$datafix;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_CBX_RESPONSE 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_CBX_RESPONSE
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_CBX_RESPONSE
BEFORE INSERT
ON CAPS.CASE_REVIEW_CBX_RESPONSE
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
BEGIN
:NEW.DT_LAST_UPDATE := sysdate;
  if :NEW.ID_CASE_REVIEW_CBX_RESPONSE=0 then
    SELECT SEQ_CASE_REVIEW_CBX_RESPONSE.NEXTVAL INTO dummy FROM DUAL;
    :NEW.ID_CASE_REVIEW_CBX_RESPONSE := dummy;
  end if;
END;
/

-- New Table CASE_REVIEW_SURVEY

create table caps.CASE_REVIEW_SURVEY
(
ID_CASE_REVIEW_SURVEY number(16) not null,
DT_LAST_UPDATE DATE not null,
CD_QUESTION VARCHAR2 (10),
CD_SURVEY_TYPE VARCHAR2(10),
CD_SURVEY_CODE VARCHAR2(10),
constraint pk_CASE_REVIEW_SURVEY PRIMARY KEY (ID_CASE_REVIEW_SURVEY) using index tablespace index01)
tablespace data01;

comment on table CAPS.CASE_REVIEW_SURVEY is 'Table to store questions code for survey types';
comment on column CAPS.CASE_REVIEW_SURVEY.CD_QUESTION is 'Code Question';
comment on column CAPS.CASE_REVIEW_SURVEY.CD_SURVEY_TYPE is 'Code Survey Type';
comment on column CAPS.CASE_REVIEW_SURVEY.CD_SURVEY_CODE is 'Code Survey Code';

grant select,update,insert,delete on CAPS.CASE_REVIEW_SURVEY to capson,capsbat,ops$datafix;
grant select on caps.CASE_REVIEW_SURVEY to operator;

CREATE SEQUENCE  CAPS.SEQ_CASE_REVIEW_SURVEY  NOMINVALUE NOMAXVALUE INCREMENT
BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;

grant select on CAPS.SEQ_CASE_REVIEW_SURVEY  to capsbat,capson,ops$datafix;

/ 
CREATE OR REPLACE TRIGGER CAPS.TUBR_CASE_REVIEW_SURVEY 
BEFORE UPDATE
ON CAPS.CASE_REVIEW_SURVEY
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
        :new.DT_LAST_UPDATE := SYSDATE;
...
/
CREATE OR REPLACE TRIGGER CAPS.TIBR_CASE_REVIEW_SURVEY
BEFORE INSERT
ON CAPS.CASE_REVIEW_SURVEY
REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
...
BEGIN
:NEW.DT_LAST_UPDATE := sysdate;
  if :NEW.ID_CASE_REVIEW_SURVEY=0 then
    SELECT SEQ_CASE_REVIEW_SURVEY.NEXTVAL INTO dummy FROM DUAL;
    :NEW.ID_CASE_REVIEW_SURVEY := dummy;
  end if;
END;
/

--STGAP00013108 - Insert data in the the static tables for Case ReviEW

--Note:  no imapct to ado model

INSERT INTO CAPS.CASE_REVIEW_CATEG_LOOKUP (CD_CATEGORY, DT_LAST_UPDATE,TXT_CATEGORY,NBR_CATEGORY_ORDER) 
VALUES ('SFT',SYSDATE,'Safety','1');

INSERT INTO CAPS.CASE_REVIEW_CATEG_LOOKUP (CD_CATEGORY, DT_LAST_UPDATE,TXT_CATEGORY,NBR_CATEGORY_ORDER) 
VALUES ('PER',SYSDATE,'Permanency','2');

INSERT INTO CAPS.CASE_REVIEW_CATEG_LOOKUP (CD_CATEGORY, DT_LAST_UPDATE,TXT_CATEGORY,NBR_CATEGORY_ORDER) 
VALUES ('WLL',SYSDATE,'Well Being','3');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('SFTIT1',SYSDATE,'Item1','1','SFT');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('SFTIT2',SYSDATE,'Item2','2','SFT');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('SFTIT3',SYSDATE,'Item3','3','SFT');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('SFTIT4',SYSDATE,'Item4','4','SFT');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT1',SYSDATE,'Item1','1','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT2',SYSDATE,'Item2','2','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT3',SYSDATE,'Item3','3','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT4',SYSDATE,'Item4','4','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT5',SYSDATE,'Item5','5','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT6',SYSDATE,'Item6','6','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT7',SYSDATE,'Item7','7','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT8',SYSDATE,'Item8','8','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT9',SYSDATE,'Item9','9','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT10',SYSDATE,'Item10','10','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT11',SYSDATE,'Item11','11','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('PERIT12',SYSDATE,'Item12','12','PER');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT1',SYSDATE,'Item1','1','WLL');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT2',SYSDATE,'Item2','2','WLL');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT3',SYSDATE,'Item3','3','WLL');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT4',SYSDATE,'Item4','4','WLL');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT5',SYSDATE,'Item5','5','WLL');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT6',SYSDATE,'Item6','6','WLL');

INSERT INTO CAPS.CASE_REVIEW_ITEM_LOOKUP (CD_ITEM, DT_LAST_UPDATE,TXT_ITEM,NBR_ITEM_ORDER, CD_CATEGORY) 
VALUES ('WLLIT7',SYSDATE,'Item7','7','WLL');
...
VALUES ('Q01',SYSDATE,
'Of all of the investigations received on this case during the period of review, were responses to all accepted maltreatment reports initiated with face to face contact with the child(ren) (who is/are the subject of the alleged maltreatment) within the assigned time frame or was there documentation that concerted diligent efforts were made to locate the child(ren) within the assigned response time frame?  (Timeliness of initiating reports of child maltreatment).'
,01,'SFTIT1', 'M', 'N',
'YNA', 'Question Help');	
...
CD_SURVEY_QUESTION_TYPE, TXT_QUES_HELP ) 
VALUES ('Q61',SYSDATE,
'If the child has been in care 15 out of the last 22 months, has the agency documented compelling reasons for not pursuing TPR?'
,61,'PERIT3', 'D', 'N',
'YNA', 'Question Help');
...
CD_SURVEY_QUESTION_TYPE, TXT_QUES_HELP) 
VALUES ('Q104',SYSDATE,
'If a parent is incarcerated, is there documentation of the agency''s efforts to facilitate other forms of contact between parent and child?'
,104,'PERIT9', 'D', 'N',
'YNA', 'Question Help');
...
CD_SURVEY_QUESTION_TYPE, TXT_QUES_HELP) 
VALUES ('Q125',SYSDATE,
'Was an FTM conducted which clearly demonstrates the inclusion of family members, child (if developmentally and age appropriate/school age), caregivers, stakeholders and service providers (within 9 days of date of removal for foster care and 45 days of initial family preservation staffing for Family Preservation cases)?'
,125,'WLLIT1', 'S', 'N',
'YNA', 'Question Help');
...
CD_SURVEY_QUESTION_TYPE, TXT_QUES_HELP) 
VALUES ('Q142',SYSDATE,
'Was the frequency and quality of the contacts between the caseworker and the child(ren) purposeful and sufficient to address issues pertaining to safety, permanency, well-being and to promote achievement of family support strategies (must at least meet minimum policy standards or standards established in the FTM)?'
,142,'WLLIT3', 'D', 'N',
'YNA', 'Question Help');
...
INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX01',SYSDATE,'Q03','County Master Files');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX02',SYSDATE,'Q03','Placement Central');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX03',SYSDATE,'Q03','GHP Portal');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX04',SYSDATE,'Q03','PSDS');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX05',SYSDATE,'Q03','IDS Master Index');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX06',SYSDATE,'Q03','SUCCESS');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX07',SYSDATE,'Q03','Sexual Offender Registry');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX08',SYSDATE,'Q03','Department Of Corrections');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX09',SYSDATE,'Q03','Boards of Pardons and Parole');

INSERT INTO CAPS.CASE_REVIEW_CBX_LOOKUP (CD_CBX_QUESTION, DT_LAST_UPDATE,CD_QUESTION, TXT_CBX_QUESTION) 
VALUES ('CBX10',SYSDATE,'Q03','SHINES');




--STGAP00013109 - Insert data in Metaphor Task for Case Review
...
INSERT INTO CAPS.TASK
 ...
 VALUES
   ('9880',SYSDATE, 'CSR', 'INT', 'CPS', '1', '1', '1', '0', '0', '0', '1', 'Case Review', 'CASE_CASESEARCH', 'CASE_MANAGEMENT_CASEMNT', 'CASE_REVIEW_EVENTLIST', '/casemgmt/CaseReview/displayCaseReview', 3);

INSERT INTO CAPS.TASK
   (CD_TASK, DT_LAST_UPDATE, CD_TASK_EVENT_TYPE, CD_TASK_STAGE, CD_TASK_STAGE_PROGRAM, IND_TASK_EVENT_CREATE, IND_TASK_EVENT_NAVIG, IND_TASK_MULTIPLE_INSTANCE, IND_TASK_NEW_USING, IND_TASK_NU_ACROSS_CASE, IND_TASK_RTRV_PRIOR_STAGE, IND_TASK_SHOW_IN_LIST, TXT_TASK_DECODE, TXT_1ST_TAB, TXT_2ND_TAB, TXT_3RD_TAB, TXT_EVENT_DETAIL_URL, IND_TASK_CODE_PREFER)
 VALUES
   ('9890', SYSDATE, 'CSR', 'INV', 'CPS', '1', '1', '1', '0', '0', '0', '1', 'Case Review', 'CASE_CASESEARCH', 'CASE_MANAGEMENT_CASEMNT', 'CASE_REVIEW_EVENTLIST', '/casemgmt/CaseReview/displayCaseReview', 3);
   
INSERT INTO CAPS.TASK
   (CD_TASK, DT_LAST_UPDATE, CD_TASK_EVENT_TYPE, CD_TASK_STAGE, CD_TASK_STAGE_PROGRAM, IND_TASK_EVENT_CREATE, IND_TASK_EVENT_NAVIG, IND_TASK_MULTIPLE_INSTANCE, IND_TASK_NEW_USING, IND_TASK_NU_ACROSS_CASE, IND_TASK_RTRV_PRIOR_STAGE, IND_TASK_SHOW_IN_LIST, TXT_TASK_DECODE, TXT_1ST_TAB, TXT_2ND_TAB, TXT_3RD_TAB, TXT_EVENT_DETAIL_URL, IND_TASK_CODE_PREFER)
 VALUES
   ('9910', SYSDATE, 'CSR', 'SUB', 'CPS', '1', '1', '1', '0', '0', '0', '1', 'Case Review', 'CASE_CASESEARCH', 'CASE_MANAGEMENT_CASEMNT', 'CASE_REVIEW_EVENTLIST', '/casemgmt/CaseReview/displayCaseReview', 3);
 
 INSERT INTO CAPS.TASK
   (CD_TASK, DT_LAST_UPDATE, CD_TASK_EVENT_TYPE, CD_TASK_STAGE, CD_TASK_STAGE_PROGRAM, IND_TASK_EVENT_CREATE, IND_TASK_EVENT_NAVIG, IND_TASK_MULTIPLE_INSTANCE, IND_TASK_NEW_USING, IND_TASK_NU_ACROSS_CASE, IND_TASK_RTRV_PRIOR_STAGE, IND_TASK_SHOW_IN_LIST, TXT_TASK_DECODE, TXT_1ST_TAB, TXT_2ND_TAB, TXT_3RD_TAB, TXT_EVENT_DETAIL_URL, IND_TASK_CODE_PREFER)
 VALUES
   ('9920', SYSDATE, 'CSR', 'ADO', 'CPS', '1', '1', '1', '0', '0', '0', '1', 'Case Review', 'CASE_CASESEARCH', 'CASE_MANAGEMENT_CASEMNT', 'CASE_REVIEW_EVENTLIST', '/casemgmt/CaseReview/displayCaseReview', 3);
  
INSERT INTO CAPS.TASK
   (CD_TASK, DT_LAST_UPDATE, CD_TASK_EVENT_TYPE, CD_TASK_STAGE, CD_TASK_STAGE_PROGRAM, IND_TASK_EVENT_CREATE, IND_TASK_EVENT_NAVIG, IND_TASK_MULTIPLE_INSTANCE, IND_TASK_NEW_USING, IND_TASK_NU_ACROSS_CASE, IND_TASK_RTRV_PRIOR_STAGE, IND_TASK_SHOW_IN_LIST, TXT_TASK_DECODE, TXT_1ST_TAB, TXT_2ND_TAB, TXT_3RD_TAB, TXT_EVENT_DETAIL_URL, IND_TASK_CODE_PREFER)
 VALUES
   ('9930', SYSDATE, 'CSR', 'DIV', 'CPS', '1', '1', '1', '0', '0', '0', '1', 'Case Review', 'CASE_CASESEARCH', 'CASE_MANAGEMENT_CASEMNT', 'CASE_REVIEW_EVENTLIST', '/casemgmt/CaseReview/displayCaseReview', 3);

INSERT INTO CAPS.TASK
   (CD_TASK, DT_LAST_UPDATE, CD_TASK_EVENT_TYPE, CD_TASK_STAGE, CD_TASK_STAGE_PROGRAM, IND_TASK_EVENT_CREATE, IND_TASK_EVENT_NAVIG, IND_TASK_MULTIPLE_INSTANCE, IND_TASK_NEW_USING, IND_TASK_NU_ACROSS_CASE, IND_TASK_RTRV_PRIOR_STAGE, IND_TASK_SHOW_IN_LIST, TXT_TASK_DECODE, TXT_1ST_TAB, TXT_2ND_TAB, TXT_3RD_TAB, TXT_EVENT_DETAIL_URL, IND_TASK_CODE_PREFER)
 VALUES
   ('9940', SYSDATE, 'CSR', 'FPR', 'CPS', '1', '1', '1', '0', '0', '0', '1', 'Case Review', 'CASE_CASESEARCH', 'CASE_MANAGEMENT_CASEMNT', 'CASE_REVIEW_EVENTLIST', '/casemgmt/CaseReview/displayCaseReview', 3);




--STGAP00013110 - Insert messages for case review
...
VALUES(SYSDATE,60520,'MSG_CSR_CFRM_COMP','Once the Case Review is marked Complete no further changes can be made. Uncheck the Complete box if additional changes are required.', 
700,500,'N');

INSERT INTO CAPS.MESSAGE(DT_LAST_UPDATE,NBR_MESSAGE,TXT_MESSAGE_NAME, 
TXT_MESSAGE,CD_SOURCE,CD_PRESENTATION,IND_BATCH) 
VALUES(SYSDATE,60521,'MSG_CSR_ANS_REQ','All questions have not been answered. Please answer marked questions.', 
700,500,'N');


--STGAP00013111 - Insert data in Codes table for Case Review

--Note: no imapct to ado model

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURSTG', 'INT', 'Survey for Investigation' ,SYSDATE );

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURSTG', 'INV', 'Survey for Intake' ,SYSDATE ); 

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURSTG', 'SUB', 'Survey for FCC' ,SYSDATE ); 

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURSTG', 'ADO', 'Survey for Adoption' ,SYSDATE ); 

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURSTG', 'FPR', 'Survey for Ongoing' ,SYSDATE ); 

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURSTG', 'DIV', 'Survey for Diversion' ,SYSDATE );  

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURQTP', 'YNA', 'Yes No NA' ,SYSDATE );

INSERT INTO CAPS.CODES_TABLES(CODE_TYPE,CODE,DECODE,DT_LAST_UPDATE) VALUES('CSURTYP', 'CSURSTG', 'Survey Based on Stages' ,SYSDATE );

INSERT INTO CAPS.CODES_TABLES (CODE_TYPE, CODE, DECODE,DT_LAST_UPDATE) VALUES('CEVNTTYP','CSR','Case Review',SYSDATE);

INSERT into CAPS.CODES_TABLES (CODE_TYPE, CODE, DECODE ,DT_LAST_UPDATE) VALUES ('CSECATTR', 'PK', 'Case Review',SYSDATE);




--STGAP00013159 - MR026: update TCM denial reaon for new TCM report

--Note:  no imapct to ado model

-- MR026: Susan Morgan requests new parameter denial reason dropdown list for TCM
-- Denied Claim List SQR report to allow user to filter denied claims by denial 
-- reason, and that denial reason displays with associated code value.
-- Recreate code table TCM denial reason: display code value in decode and 
-- reword decode; add 3 more codes per design update.

update caps.codes_tables set decode = '1128 - The Member ID is missing or invalid' where code = '1128' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2141 - Member not found' where code = '2141' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2143 - Member not eligible' where code = '2143' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2222 - Member name mismatch' where code = '2222' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2266 - QMB member elig for crossover only' where code = '2266' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2712 - Member elected to receive hospice  ' where code = '2712' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2714 - Claim spans a member hospice  ' where code = '2714' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2716 - Member elected to receive hospice  ' where code = '2716' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2723 - Member name is missing or invalid' where code = '2723' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2725 - Peachcare - conflict exists  ' where code = '2725' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2727 - Hospice certification pending' where code = '2727' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2746 - Claim exceeds filing time period  ' where code = '2746' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '2750 - Date of birth mismatch' where code = '2750' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '4117 - Procedure/age conflict' where code = '4117' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '4321 - The procedure code is not covered' where code = '4321' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '4354 - Missing Service Pricing  ' where code = '4354' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '4355 - Procedure/age conflict for service' where code = '4355' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '4908 - Procedure requires price' where code = '4908' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '5750 - Member has primary insurance  ' where code = '5750' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '5761 - Member has COB resource ' where code = '5761' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '6007 - Procedures code not allowed DOS' where code = '6007' and code_type = 'CTCMDEN';
update caps.codes_tables set decode = '6029 - Claim billed same calendar month  ' where code = '6029' and code_type = 'CTCMDEN';

insert into caps.codes_tables (code_type, code, decode) values ('CTCMDEN','4112','4112 - Low Variance');
insert into caps.codes_tables (code_type, code, decode) values ('CTCMDEN','6101','6101 - Exact Duplicate');
insert into caps.codes_tables (code_type, code, decode) values ('CTCMDEN','2343','2343 - Member enrolled in a CMO');



--STGAP00013160 - MR026: New SQR report TCM Denied Claims

--Note:  no imapct to ado model

--MR026: New SQR report TCM Denied Claims
-- Associated DBCR: STGAP00013159
...
VALUES ('TCMDeniedClaimList', '00', 7, 'A', 'TCM Denial Claims', 'ondport', 'L',
 'W', 'A list of all denied claims by region, county and denial reason. Generated for a specific service date range, with optional region, county, and denial reason parameters.', 'TCM', 'Y');
...
'TCMDeniedClaimList', '00', 1, 10, 'BEGINDATE', 'DATE', 'Y', 'Service date from (MM/DD/YYYY)');

INSERT INTO CAPS.REPORT_PARAMETER ( NM_RPT_SQR_NAME, NM_RPT_SQR_VER, NBR_RPT_PARM_SEQ
, NBR_RPT_PARM_LENGTH, NM_RPT_PARM_NAME,
TXT_RPT_PARM_TYPE, IND_REQUIRED, NM_RPT_PARM_LABEL ) VALUES (
'TCMDeniedClaimList', '00', 2, 10, 'ENDDATE', 'DATE', 'Y', 'Service date to (MM/ DD/YYYY)');

INSERT INTO CAPS.REPORT_PARAMETER (NM_RPT_SQR_NAME, NM_RPT_SQR_VER, NBR_RPT_PARM_SEQ,
 NBR_RPT_PARM_LENGTH, NM_RPT_PARM_NAME,
TXT_RPT_PARM_TYPE, IND_REQUIRED, NM_RPT_PARM_LABEL ) VALUES (
'TCMDeniedClaimList', '00', 3, 4, 'TCMDENIALREASONCD', 'CHAR', 'N', 'TCM Denial Reason');

INSERT INTO CAPS.REPORT_PARAMETER (NM_RPT_SQR_NAME, NM_RPT_SQR_VER, NBR_RPT_PARM_SEQ,
 NBR_RPT_PARM_LENGTH, NM_RPT_PARM_NAME, TXT_RPT_PARM_TYPE, IND_REQUIRED, NM_RPT_PARM_LABEL ) VALUES (
'TCMDeniedClaimList', '00', 4, 2, 'REGIONCD', 'CHAR', 'N', 'Region');
...
'TCMDeniedClaimList', '00', 5, 3, 'COUNTYCD', 'CHAR', 'N', 'County');



insert into caps.schema_version (id_schema_version, application_version, comments)
                        values (451, 'SacwisRev3', 'Release 3.1 - DBCRs 13107,13108,13109,13110,13111,13159,13160');
