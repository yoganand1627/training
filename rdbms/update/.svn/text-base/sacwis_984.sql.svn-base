--STGAP00016100 - Release(4.2) MR-075  Update TUBR_CAPS_RESOURCE trigger

--MR-075 Update TUBR_CAPS_RESOURCE trigger to set reimbursability on same day as approved home closure and update any previous resource history record to avoid period overlaps.
...
insert into caps.schema_version(id_schema_version,application_version,comments)
            values (985, 'SacwisRev4', 'Release 4.2 - DBCR 16100');
