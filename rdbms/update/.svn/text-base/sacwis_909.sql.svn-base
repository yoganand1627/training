...
--MR-074: AFCARS Phase 1 Add New Columns in CAPS.PERSON_ENC

ALTER TABLE CAPS.PERSON_ENC ADD IND_SINGLE_PAR_ADOPT VARCHAR2(1);
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_SINGLE_PAR_ADOPT IS 'Indicator whether single parent adoption or not';

ALTER TABLE CAPS.PERSON_ENC ADD CD_SINGLE_MOTHER_FATHER VARCHAR2(2);
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_SINGLE_MOTHER_FATHER IS 'Code indicating whether a previous single parent adoption was single mother or single father';
