...
;
COMMENT ON TABLE CAPS.FCE_APPLICATION_ENC IS 'Information used to determine a child''s initial eligibility for Federal Title IV-E foster care assistance.
'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_FCE_APPLICATION IS 'Primary key of the FCE_APPLICATION table.
'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_EVENT IS 'A unique identifier to the EVENT table.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_CASE IS 'Unique identifier for CAPS Case.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_STAGE IS 'A unique identifier for a row on the STAGE table.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_PERSON IS 'Id of child for whom the referral was sent  ID_PERSON of the child whose information is described in this row.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_LAST_UPDATE_PERSON IS 'ID_PERSON of person to last update the current row in this table.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_MNGNG_CVS_PERSON IS 'Foreign key for the ID_PERSON of the relative with managing conservatorship during the 6 months prior to the court proceedings being initiated in the PERSON table.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_OTHER_RELATIVE_PERSON IS 'Foreign key for the ID_PERSON of the relative with whom the child was living during the month the court proceedings were initiated in the PERSON table.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ID_FCE_ELIGIBILITY IS 'Primary key of the FCE_ELIGIBILITY table.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_LAST_UPDATE IS 'Date of last update shows when the record was last modified.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_HEALTH_ADDR_CITY IS 'Health Insurance Address City.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_HEALTH_ADDR_ST_LN_1 IS 'Health Insurance Street Address 1.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_HEALTH_ADDR_ST_LN_2 IS 'Health Insurance Street Address 2.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_HEALTH_ADDR_ZIP IS 'Health Insurance Address Zip.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_REMOVAL_ADDR_ZIP IS 'Zip of the child''s address in the Home of Removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_REMOVAL_CITY IS 'City of the child''s address of the Home of Removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_REMOVAL_ST_LN_1 IS 'Street address line 1 of the Home of Removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.ADDR_REMOVAL_ST_LN_2 IS 'Street address line 2 of the child Home of Removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_APPLICATION IS 'Code indicating that this is either the first application or a reapplication for a case.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_COUNTY_HOSPITAL IS 'County in which the hospital is located.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_HEALTH_ADDR_STATE IS 'Health Insurance Address State.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_LIVING_MONTH_REMOVAL IS 'The living situation of the child during month court proceedings were initiated.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_NOTA_MOST_RECENT IS 'Most recent living situation for the child before removal if he or she was living with a parent or other relative at any time during the 6 months before removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_REMOVAL_ADDR_COUNTY IS 'County of the child''s address in the Home of Removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_REMOVAL_ADDR_STATE IS 'State of the child''s address in the Home of Removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.CD_STATE IS 'State code for the state in which the hospital is located.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_APPLICATION_COMPLETE IS 'Date the application or reapplication was completed.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_HEALTH_BEGIN_DATE IS 'Health Insurance Begin Date.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_HEALTH_END_DATE IS 'Health Insurance End Date.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_HOSPITAL_ADMISSION IS 'Date the child was admitted to the hospital.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_HOSPITAL_DISCHARGE IS 'Date the child was discharged from the hospital.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_NOTIFIED_WORKER IS 'Date that the worker was notified that the child was removed from the home.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_PROOF_AGE_SENT_ES IS 'Date on which proof of age was sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_PROOF_CITIZENSHIP_SENT_ES IS 'Date on which proof of citizenship was sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_BAPTISM_CERT IS 'Indicates that the child''s age was verified by a baptismal age certificate.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_FOREIGN_CERT IS 'Indicates that the child''s age was verified by a foreign birth certificate.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_US_BIRTH_CERT IS 'Indicates that the child''s age was verified by a US birth certificate.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_JUSTIFIED_EVAL IS 'Indicates that the child''s age was approximated and justified using an Evaluative Conclusion.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_HOSPITAL_CERT IS 'Indicates that the child''s age was verified by a hospital certificate.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_NTRLZTN_CERT IS 'Indicates that the child''s age was verified by a naturalization certificate.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_PASSPORT IS 'Indicates that the child''s age was verified by a US passport.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_RESIDENT_CARD IS 'Indicates that the child''s age was verified by a US resident card.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_CHILD_SUPPORT_ORDER IS 'Indicates that child support was court ordered to be paid to DFCS.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_EVALUATION_CONCLUSION IS 'An evaluative conclusion has been completed regarding the child''s age and/or citizenship.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_HOSPITAL IS 'Indicates that the child was in the hospital when DFCS was appointed managing conservator.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_INCOME_ASSISTANCE IS 'Indicates that the child received income assistance in the form of TANF, Food Stamps, or Medicaid.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_LEGAL_DOCS_SENT_ES IS 'Indicates that all legal documentation has been sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_LIVING_RELATIVE_SIX_MONTH IS 'Indicates that the child was living with a parent or relative who had managing conservatorship at some time during the 6 months prior the court proceedings being initiated.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_MANAGING_CVS IS 'Indicates that another person had managing conservatorship besides the parent at time of removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_MINOR_PARENT IS 'Indicates that the child''s parent is a minor in DFCS''s managing conservatorship.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_NOTIFIED_DHS_WORKER IS 'Indicates that the DHS worker was notified that the child was removed from the home.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_OTHER_HEALTH_INSURANCE IS 'Indicates that the child is covered by insurance other than Medicaid.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_PROOF_AGE_SENT_ES IS 'Indicates that proof of age was sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_PROOF_CITIZENSHIP_SENT_ES IS 'Indicates that proof of citizenship was sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NBR_COURT_MONTH IS 'Month in which court procedings were initiated for domicile and deprivation determination.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NBR_COURT_YEAR IS 'Year in which court procedings where initiated for domicile and deprivation determination.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NBR_HEALTH_GROUP IS 'Health Insurance Group Number.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NBR_LIVING_AT_HOME IS 'Number of people living in the home of removal.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NBR_NOTIFIED_DHS_WRKR_PHN IS 'Work phone number of the worker who was notified that the child was removed from the home.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_HEALTH_COMPANY IS 'Health Insurance Company Name.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_HEALTH_EMPLOYEE_NM IS 'Health Insurance Employee Name.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_HEALTH_EMPLOYER_NM IS 'Health Insurance Employer''s Name.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_HEALTH_POLICY_HLDR_NM IS 'Health Insurance Policy Holder.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_HOSPITAL IS 'The hospital name used to find documentation about the mother of the child.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_HOSPITAL_CITY IS 'City in which the hospital is located.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_MOTHER_MAIDEN IS 'Maiden name of the child''s mother.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_NOTIFIED_DHS_WRKR_FIRST IS 'First name of the worker who was notified that the child was removed from the home.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_NOTIFIED_DHS_WRKR_LAST IS 'Last name of the worker who was notified that the child was removed from the home.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NM_NOTIFIED_DHS_WRKR_MIDDLE IS 'Middle name of the worker who was notified that the child was removed from the home.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_INCOME_DTRMNTN_COMMENTS IS 'Summary of how the family''s and child''s income were determined.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_LEGAL_DOCS_SENT_ES IS 'Comments describing the status of legal documents sent or not sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_MEETS_DD_OR_NOT_COMMENTS IS 'Stores comments regarding the child''s Title IV-E deprivation status from the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_NO_INCOME_EXPLANATION IS 'Explanation of how the child and family''s monthly living expenses are met if no monthly income.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_PROOF_AGE_SENT_ES IS 'Comments describing why proof of age was not sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_PROOF_CITIZENSHIP_SENT_ES IS 'Comments describing why proof of citizenship was not sent to the Eligibility Specialist.'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_SUCCESS_SYSTEM IS 'Indicator if the age was verified through SUCCESS'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_AGE_VRFD_SAVE_SYSTEM IS 'Indicator if the age was verified through SAVE'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_EVAL_REVIEW_EC_ES IS 'Indicator if the Eligibility Specialist reviewed the Evaluative Conclusion'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_MEDICAL_ASSISTANCE IS 'Indicator if child needed medical assistance for the prior 3 months'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_MONTH_MEDICAL_ASSISTANCE IS 'Months that medical assistance was needed'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_PRF_PREGNANCY_SENT_ES IS 'Indicator if proof of pregnancy was sent to the eligibility specialist'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_PRF_PREGNANCY_SENT_ES IS 'Comments about the proof of pregnancy'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_PRIOR_REMOVAL_MONTHS IS 'months that medical assistance was needed within the 3 months prior to removal'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.IND_PROOF_CHILD_ID_SENT_ES IS 'Boolean Indicator for the question "Are copies of all documents used to verify the child''s Identity being provided to the Eligibility Specialist?"  '
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_PROOF_CHILD_ID_SENT_ES IS 'Date field for when the documents were provided to the Eligibility Specialist'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_PROOF_CHILD_ID_SENT_ES IS 'Comments field to enter comments what documents are provided and if the documents are not provided then why not?'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_PROOF_PREGNANCY_SENT_ES IS 'Date field for when the documents were provided to the Eligibility Specialist'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.TXT_EMPLOYEE_COMMENTS IS 'Comments field allows Case Managers to document additional notes which are submitted to the Eligibility Specialist'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.DT_LEGAL_DOCS_SENT_ES IS 'Date when legal documents were provided to the Eligibility Specialist, including the Affidavit, Petition, and Court Orders'
;
COMMENT ON COLUMN CAPS.FCE_APPLICATION_ENC.NBR_HEALTH_POLICY IS 'Health Insurance Policy Number.'
;
...
;
COMMENT ON TABLE CAPS.FCE_THIRD_PARTY_INSURANCE_ENC IS 'Foster Care table documenting if the child had other insurance'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.ID_FCE_APPLICATION IS 'Primary key of the FCE_APPLICATION table.
'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.DT_LAST_UPDATE IS 'Date of insert or last update'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.IND_CHILD_COVERAGE IS 'Indicator if the child is covered by any 3rd party health insurance'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.CD_TYPE IS 'Type of insurance'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NM_COMPANY IS 'Company Name'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NBR_GROUP IS 'Group Number'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.ADDR_STREET_LN1 IS 'Address Line 1'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.ADDR_STREET_LN2 IS 'Address Line 2'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.ADDR_CITY IS 'City'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.ADDR_STATE IS 'State'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.ADDR_ZIP IS 'Zip Code'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NBR_PHONE IS 'Phone Number'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.DT_BEGIN IS 'Begin date of coverage'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.DT_END IS 'End Date of Coverage'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NM_EMPLOYER IS 'Name of the Employer'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NM_EMPLOYEE_NAME IS 'Name of the Employee'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.IND_AUTH_RELEASE IS 'Indicator if the person authorized the release of information to DCH'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.IND_AUTH_ASSIGN IS 'Indicator if the person authorized and assigned payments to DCH'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.DT_AUTH_RELEASE IS 'Date of the authorization of release of information'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.DT_AUTH_ASSIGN IS 'Date of the authorization of assignment of payments'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.IND_CHANGE_CANCEL IS 'Indicator if the insurance changed or was cancelled'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.DT_CHANGE_CANCEL IS 'Date of the change or cancellation'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NM_POLICY_HOLDER IS 'Name of the Policy Holder'
;
COMMENT ON COLUMN CAPS.FCE_THIRD_PARTY_INSURANCE_ENC.NBR_POLICY IS 'Policy Number'
;
...
;
COMMENT ON TABLE CAPS.MEDICATION_ENC IS 'A list of medications that a person in a case is taking.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.ID_MEDICATION IS 'Unique identifier for the medication record for a person in the case.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.ID_PERSON IS 'A unique identifier for a row on the Person table that is taking the medication in this record.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.DT_LAST_UPDATE IS 'Date of insert or last update'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.CD_MEDCTN_DOSE IS 'The code for the dosage of the medication being taken.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.TXT_MEDCTN_ADMIN_PERSON IS 'Contains the person who is administering the medication to the person.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.DT_MEDCTN_PRESC IS 'The date this medication was prescribed.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.DT_MEDCTN_END_DATE IS 'The end date, if known, for the person to be taking this medication.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.IND_MEDCTN_ALLERGIES IS 'Indicator if person is known to have any allergies to this medication.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.TXT_MEDCTN_DESCRIP IS 'A description of this medication.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.TXT_MEDCTN_CMNTS IS 'Comments associated with this medication.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.TXT_MEDCTN_PRESC_PERSON IS 'Name of the person who prescribed the medication.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.NM_PHARMACY IS 'Pharmacy Name'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.ADDR_PHARM_ST_LN_1 IS 'Pharmacy Address Details '
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.ADDR_PHARM_ST_LN_2 IS 'Pharmacy Address Details '
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.ADDR_PHARM_CITY IS 'Pharmacy Address City'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.CD_ADDR_PHARM_STATE IS 'Pharmacy Address State'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.ADDR_PHARM_ZIP IS 'Pharmacy Address Zip Code'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.NBR_PHARM_PHONE IS 'Pharmacy Phone Number'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.NM_MEDCTN IS 'Name of the medication.'
;
COMMENT ON COLUMN CAPS.MEDICATION_ENC.TXT_MEDCTN_REASON IS 'The reason why the medication was prescribed for the person.'
;
...
;
COMMENT ON TABLE CAPS.PERSON_ENC IS 'An individual known to DFCS. Persons include Principals, Collaterals, Employees, Professionals, and Foster/Adoptive Family Members. This table includes all the details that could be captured regardless of whether they are an employee, principal, collateral. Note: not all information will be captured for an employee.
'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.ID_PERSON IS 'Id of child for whom the referral was sent  A unique identifier for a row on the Person table.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.DT_LAST_UPDATE IS 'Date of last update shows when the record was last modified.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_SEX IS 'Code representing an individual''s sex.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.ADDR_PERSON_ST_LN_1 IS 'Street address for an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.ADDR_PERSON_CITY IS 'City of an  individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.ADDR_PERSON_ZIP IS 'Numeric zip code for an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.DT_PERSON_DEATH IS 'A date indicating the death of a child/adult involved in an open case.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.DT_PERSON_BIRTH IS 'A date indicating the date of birth of an iindividual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_RELIGION IS 'Code representing a religion for an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_CHAR IS 'Code indicating whether a person characteristic record exists for an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_LIV_ARR IS 'Code indicating the living arrangement of the person.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERS_GUARD_CNSRV IS 'Code indicating whether guardianship has been assigned.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_STATUS IS 'Code indicating whether an individual is involved in an active case.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_DEATH IS 'Code representing the reason an individual died. (i.e. whether or not it was related to abuse/neglect.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_MARITAL_STATUS IS 'Code representing the marital status of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_LANGUAGE IS 'Code representing the language spoken by an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_ETHNIC_GROUP IS 'Code representing the ethnicity of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_STATE IS 'Abbreviated state code for an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_COUNTY IS 'Code representing the county in which an individual lives.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_PERSON_DOB_APPROX IS 'Indicates that the persons Date of Birth is approximate.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_PERS_CANCEL_HIST IS 'Indicates whether a row should be written to the person history table or not for an insert or update to the person table. Not stored on the person table.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NBR_PERSON_AGE IS 'The numeric age, actual or estimated, of each principal (not reporter or collateral) involved in the case. Integer describing a person''s age.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NBR_PERSON_PHONE IS 'Phone number of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NM_PERSON_FIRST IS 'First name of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NM_PERSON_MIDDLE IS 'Middle name of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NM_PERSON_LAST IS 'Last name of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NM_PERSON_FULL IS 'Full name of an individual.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.TXT_PERSON_OCCUPATION IS 'Contains the individual''s occupation (not employment status).'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_SUFFIX IS 'Code representing the suffix appended to a name for distinction (e.g. ,Jr., Sr.)'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_AUTO_PERS_MERGE IS 'The indicator is used by the automated person merge program to identify which person records have been processed (looked at as a possible mergee) by the automated person merge program.  It isn''t used by any other program including the on-line person merge.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_DISASTER_RLF IS 'If this person was related to a disaster'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_TITLE IS 'Person''s Title, e.g. Mr., Mrs.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_PERSON_US_CITIZEN IS 'Indicator if the Person is a U.S. Citizen'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_IMMIGRATION_STATUS IS 'Immigration Status of the Person'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_COUNTRY_ORIGIN IS 'Person''s official country of origin '
;
COMMENT ON COLUMN CAPS.PERSON_ENC.TXT_CHAR_CMNTS IS 'Characteristic comments for a Person'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERS_NOT_YET_DIAG IS 'Indicates if Person has been diagnosed'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_PERSON_PROOF_CITIZENSHIP IS 'Defines how citizenship was proven/established.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.TXT_PERSON_OTHER_RELATIONSHIPS IS 'Text describing other relationships this person has not documented in RELATIONSHIPS table.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_MATCH_TYPE IS 'Background check match type.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_SMILE_CLIENT IS 'Cd to signify if the person is registered SMILE client'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.TXT_IDS_NUMBER IS 'Child''s IDS case number'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_PREV_ADOPTED IS 'Indicator  that stores previously adopted data.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_PRIVATE IS 'Data that stores whether the child is Private Adoption'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_PUBLIC IS 'Data that stores whether the child is Public Adoption'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_INTRNTL IS 'Data that stores whether the child is  International Adoption'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_ADOPT_STATE IS 'Stores adoption state'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_ADOPT_COUNTY IS 'Stores adoption county'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.CD_ADOPT_CNTRY IS 'Stores adoption country'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_ADOPT_DISLUTON IS 'Indicator  that stores adoption dissolution data.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.TXT_PERSON_ADDL_CMNTS IS 'Additional comments for this person.'
;
COMMENT ON COLUMN CAPS.PERSON_ENC.IND_ADOPT_FINALIZED IS 'Indicator if child had a finalized adoption.  This will be used to exclude this child from search results.'
;
...
;
COMMENT ON COLUMN CAPS.PERSON_ENC.NBR_PERSON_ID_NUMBER IS 'Contains the various id''s entered for a specific person.  On the PERSON table, this data element contains the Social Security Number.
'
;
...
;
COMMENT ON TABLE CAPS.PERSON_ID_ENC IS 'Identifiers for Persons known to DFCS (i.e. DHS, SSN, MHMR).
'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.ID_PERSON_ID IS 'A unique identifier for the Person Id table.'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.DT_LAST_UPDATE IS 'Date of last update shows when the record was last modified.'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.ID_PERSON IS 'Id of child for whom the referral was sent  A unique identifier for a row on the Person table.'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.CD_PERSON_ID_TYPE IS 'Contains the type of id entered on the Person Identifiers window.'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.DESC_PERSON_ID IS 'Contains free-form text entered in screen element labeled "Comments" on Person Identifier window (cint14w).'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.IND_PERSON_ID_INVALID IS 'This field is used to indicate whether or not the value in NBR PERSON ID NUMBER is valid or invalid.  A value of Y indicates the number is invalid.'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.DT_PERSON_ID_START IS 'Date the completed child plan was signed by the child (optional) (No default).'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.DT_PERSON_ID_END IS 'Date the completed child plan was signed by the child (optional) (No default).'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.IND_VALIDATE_BY_INTERFACE IS 'If ID was validated by an interface'
;
COMMENT ON COLUMN CAPS.PERSON_ID_ENC.NBR_PERSON_ID_NUMBER IS 'Contains the various id''s entered for a specific person.  On the PERSON table, this data element contains the Social Security Number.'
;
