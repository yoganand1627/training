...
alter table sacwisifc.client_outbound add ID_PERSON_CLOSED NUMBER(16,0);

comment on column SACWISIFC.CLIENT_OUTBOUND.ID_PERSON_CLOSED is 'Shines id of closed person in merge';
