--STGAP00016125 - Release(4.2) MR-075 Update TIBR_CAPS_RESOURCE trigger

-- MR-075 Update TIBR_CAPS_RESOURCE trigger to set previous reimbursability end date
...
--
  ...
  IF NVL(:NEW.IND_RSRC_WRITE_HIST,'N') = 'Y' THEN
    ...
    -- of the new record effective date or old effective date.
  ...
  --      of RH.DT_REIMBURSABLE_EFFECTIVE or :NEW.DT_REIMBURSABLE_EFFECTIVE minus 1 ms date.
...
insert into caps.schema_version(id_schema_version,application_version,comments)
            values (1006, 'SacwisRev4', 'Release 4.2 - DBCR 16125');
