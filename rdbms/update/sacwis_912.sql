--STGAP00016017 - Release(4.1) Update PERSON_HISTORY to be in sync with PERSON

--Update the PERSON_HISTORY table so that it has the new fields that have been added to the PERSON (PERSON_ENC) table.  Also update the trigger which populates the PERSON_HISTORY table (TUBR_PERSON).


alter table caps.person_history add DT_DISSOLUTION DATE;
alter table caps.person_history add DT_PREV_ADOPTION DATE;
alter table caps.person_history add TXT_NAME_OF_ADO_AGENCY VARCHAR2(80);
alter table caps.person_history add IND_ADOPT_FINALIZED VARCHAR2(1);
alter table caps.person_history add IND_ADOPT_AFCARS_SENT VARCHAR2(1);
alter table caps.person_history add IND_ADOPTED VARCHAR2(1);
alter table caps.person_history add IND_SINGLE_PAR_ADOPT VARCHAR2(1);
alter table caps.person_history add CD_SINGLE_MOTHER_FATHER VARCHAR2(2);
...
insert into caps.schema_version(id_schema_version,application_version,comments)
            values (913, 'SacwisRev4', 'Release 4.1 - DBCR 16017');
