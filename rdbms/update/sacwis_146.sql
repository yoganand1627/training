...
ALTER TABLE CAPS.CAPS_RESOURCE DROP (CD_RSRC_ADDR_SMILEUPD_ST)
;
ALTER TABLE CAPS.PAYMENT_OF_CARE MODIFY(ID_RESOURCE   NULL)
;
ALTER TABLE CAPS.RESOURCE_ADDRESS ADD CD_RSRC_ADDR_SMILEUPD_ST VARCHAR2(8)     NULL
;
ALTER TABLE CAPS.RESOURCE_HISTORY DROP (CD_RSRC_ADDR_SMILEUPD_ST)
;
ALTER TABLE CAPS.RESOURCE_HISTORY_AUDIT DROP (CD_RSRC_ADDR_SMILEUPD_ST)
;
ALTER TABLE CAPS.TCM_CLAIM MODIFY(NBR_TCN  VARCHAR2(17))
;
...
-- Create Synonyms
create synonym CAPS.SEQ_CLIENT_OUTBOUND for SACWISIFC.SEQ_CLIENT_OUTBOUND;
create synonym CAPS.SEQ_CRS_AUDIT for SACWISIFC.SEQ_CRS_AUDIT;
create synonym CAPS.SEQ_INCOME_RESOURCE_OUTBOUND for SACWISIFC.SEQ_INCOME_RESOURCE_OUTBOUND;
create synonym CAPS.SEQ_INVOICE_OUTBOUND for SACWISIFC.SEQ_INVOICE_OUTBOUND;
create synonym CAPS.SEQ_MEDICAID_COAREQ_OUTBOUND for SACWISIFC.SEQ_MEDICAID_COAREQ_OUTBOUND;
create synonym CAPS.SEQ_TCM_CLAIM_OUTBOUND for SACWISIFC.SEQ_TCM_CLAIM_OUTBOUND;
create synonym CAPS.SEQ_VENDOR_OUTBOUND for SACWISIFC.SEQ_VENDOR_OUTBOUND;

create synonym CAPSON.SEQ_CLIENT_OUTBOUND for SACWISIFC.SEQ_CLIENT_OUTBOUND;
create synonym CAPSON.SEQ_CRS_AUDIT for SACWISIFC.SEQ_CRS_AUDIT;
create synonym CAPSON.SEQ_INCOME_RESOURCE_OUTBOUND for SACWISIFC.SEQ_INCOME_RESOURCE_OUTBOUND;
create synonym CAPSON.SEQ_INVOICE_OUTBOUND for SACWISIFC.SEQ_INVOICE_OUTBOUND;
create synonym CAPSON.SEQ_MEDICAID_COAREQ_OUTBOUND for SACWISIFC.SEQ_MEDICAID_COAREQ_OUTBOUND;
create synonym CAPSON.SEQ_TCM_CLAIM_OUTBOUND for SACWISIFC.SEQ_TCM_CLAIM_OUTBOUND;
create synonym CAPSON.SEQ_VENDOR_OUTBOUND for SACWISIFC.SEQ_VENDOR_OUTBOUND;

create synonym CAPSBAT.SEQ_CLIENT_OUTBOUND for SACWISIFC.SEQ_CLIENT_OUTBOUND;
create synonym CAPSBAT.SEQ_CRS_AUDIT for SACWISIFC.SEQ_CRS_AUDIT;
create synonym CAPSBAT.SEQ_INCOME_RESOURCE_OUTBOUND for SACWISIFC.SEQ_INCOME_RESOURCE_OUTBOUND;
create synonym CAPSBAT.SEQ_INVOICE_OUTBOUND for SACWISIFC.SEQ_INVOICE_OUTBOUND;
create synonym CAPSBAT.SEQ_MEDICAID_COAREQ_OUTBOUND for SACWISIFC.SEQ_MEDICAID_COAREQ_OUTBOUND;
create synonym CAPSBAT.SEQ_TCM_CLAIM_OUTBOUND for SACWISIFC.SEQ_TCM_CLAIM_OUTBOUND;
create synonym CAPSBAT.SEQ_VENDOR_OUTBOUND for SACWISIFC.SEQ_VENDOR_OUTBOUND;


ALTER INDEX SACWISIFC.PK_CLIENT_OUTBOUND 
REBUILD TABLESPACE INDEX01
;
ALTER INDEX SACWISIFC.PK_CRS_AUDIT 
REBUILD TABLESPACE INDEX01
;
ALTER INDEX SACWISIFC.PK_INCOME_RESOURCE_OUTBOUND 
REBUILD TABLESPACE INDEX01
;
ALTER INDEX SACWISIFC.PK_INVOICE_OUTBOUND 
REBUILD TABLESPACE INDEX01
;
ALTER INDEX SACWISIFC.PK_MEDICAID_COAREQ_OUTBOUND 
REBUILD TABLESPACE INDEX01
;
ALTER TABLE SACWISIFC.TCM_CLAIM_OUTBOUND ADD DT_SERVICE DATE     NULL
;
ALTER TABLE SACWISIFC.TCM_CLAIM_OUTBOUND ADD DIAGNOSTIC_CODE VARCHAR2(5)     NULL
;
ALTER INDEX SACWISIFC.PK_TCM_CLAIM_OUTBOUND 
REBUILD TABLESPACE INDEX01
;
ALTER INDEX SACWISIFC.PK_VENDOR_OUTBOUND 
REBUILD TABLESPACE INDEX01
;
...
-- change STGAP00001883
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','INT','INT',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','INV','INV',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','FPR','ONG',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','SUB','FCC',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','FSU','FCF',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','ADO','ADO',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','PAD','PAD',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','PFC','PFC',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','FAD','FAD',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','ARI','ARI',sysdate);
insert into caps.codes_tables
(code_type, code, decode, dt_last_update)
values
('CTXTOGA','DIV','DIV',sysdate);


insert into caps.schema_version (id_schema_version, application_version, comments)
                         values (147, 'SacwisRev2', 'static updates, add fields, add table');
commit;                         
