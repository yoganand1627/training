--STGAP00015903 - Release(3.6) MR-66: Update Leagal Status View with new codes
...
(
   'JCD','NCS','PCT','PVL','TCT','TVL','JCP','JCT','STE'
)
...
insert into caps.schema_version(id_schema_version,application_version,comments)
            values (826, 'SacwisRev3', 'Release 3.6 - DBCR 15903');
