...
constraint fk_ID_CHILD foreign key(id_child) references caps.person(id_person),
constraint fk_ID_PRIMARY_PERSON foreign key(id_primary_person) references caps.person(id_person),
constraint fk_ID_SPOUSE foreign key(id_spouse) references caps.person(id_person),
