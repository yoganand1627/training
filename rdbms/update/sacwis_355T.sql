...
alter table caps.person add dt_dissolution date;
alter table caps.person add dt_prev_adoption date;
alter table caps.person add txt_name_of_ado_agency varchar2(80);
