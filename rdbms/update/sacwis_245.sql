...
ALTER TABLE CAPS.RESOURCE_HISTORY ADD TXT_HM_PRG_INTEREST VARCHAR2(80)     NULL
;
ALTER TABLE CAPS.RESOURCE_HISTORY_AUDIT ADD TXT_HM_PRG_INTEREST VARCHAR2(80)     NULL
;
ALTER TABLE CAPS.CAPS_RESOURCE ADD TXT_HM_PRG_INTEREST VARCHAR2(80)     NULL
;
...
BEGIN
        ...
        THEN
           UPDATE_WORKLOAD_COUNTS(:NEW.ID_PERSON, :NEW.ID_UNIT);
        END IF;
END;
/
/
...
-- change STGAP00005709
UPDATE CAPS.MESSAGE SET TXT_MESSAGE='Please provide Comments as to why the Actual Eligibility is different from the System-Derived Determination.' WHERE NBR_MESSAGE=60366;

-- change STGAP00005727
-- STGAP00005705: New codes table for Invoice Specific
-- Adjustment field on Invoice Header
INSERT INTO CAPS.CODES_TABLES
(code_type, code, DECODE, dt_last_update)
VALUES
('CINVADJT', 'Y', 'Yes', SYSDATE);

INSERT INTO CAPS.CODES_TABLES
(code_type, code, DECODE, dt_last_update)
VALUES
('CINVADJT', 'N', 'No', SYSDATE);

INSERT INTO CAPS.CODES_TABLES
(code_type, code, DECODE, dt_last_update)
VALUES
('CINVADJT', 'C', 'IV-E', SYSDATE);

-- Also remove Administrative as valid invoice type
UPDATE CAPS.CODES_TABLES SET dt_end=SYSDATE WHERE code_type='CINVTYPE' AND code='ADM';
UPDATE CAPS.CODES_TABLES SET dt_end=SYSDATE WHERE code_type='CINVTYPE' AND code='EAD';

insert into caps.schema_version (id_schema_version, application_version, comments)
                        values (246, 'SacwisRev2', 'static table updates');                        
commit;
;