--STGAP00015454 - Insert new 518 Service codes
...
svcCode := '51863a';	
svcDesc := '51863a - Initial Engagement w/ Family';	
progCode := '518';	
entCode := '63';	
newProg := FALSE;	
newEnt := TRUE;	
progDesc := '';	
entDesc := '63 - Integrated Famity Supp Serv - CCFA W';	
sa := TRUE;	
pssf := FALSE;	
...
svcCode := '51863c';	
svcDesc := '51863c - Coaching Sessions';	
progCode := '518';	
entCode := '63';	
newProg := FALSE;	
newEnt := FALSE;	
...
svcCode := '51863d';	
svcDesc := '51863d - Home Visit Sessions';	
progCode := '518';	
entCode := '63';	
newProg := FALSE;	
newEnt := FALSE;	
...
svcCode := '51863e';	
svcDesc := '51863e - Completion of summaries & case notes';	
progCode := '518';	
entCode := '63';	
newProg := FALSE;	
newEnt := FALSE;	
...
svcCode := '51863f';	
svcDesc := '51863f - Module Completion & Followup';	
progCode := '518';	
entCode := '63';	
newProg := FALSE;	
newEnt := FALSE;	
...
insert into caps.schema_version (id_schema_version, application_version, comments)
                        values (563, 'SacwisRev3', 'Release 3.3 - DBCR 15454');
