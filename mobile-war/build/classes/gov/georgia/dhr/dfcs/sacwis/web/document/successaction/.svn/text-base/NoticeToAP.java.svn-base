...
public class NoticeToAP extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("NoticeToAP", "execute");
    ...
    rowccmn01uig00.setSzTxtEventDescr(AP_EVENT_DESCRIPTION);
    rowccmn01uig00.setUlIdPerson(UserProfileHelper.getUserProfile(request).getUserID());
  ...
  // Event-Contact Constants for cfiv2400
  ...
  public final String AP_EVENT_DESCRIPTION = "Investigation Notice to A/P Ruled Out Form";
