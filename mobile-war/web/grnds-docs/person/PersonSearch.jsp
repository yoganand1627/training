...
//      }
      ...
      if (/*request.getAttribute(IntakeConstants.SEARCH_INTAKE) != null || */ request.getAttribute("indPersonList") != null) {
        ...
        //-- SIR STGAP00000887
        String genderSpecified = ""; //(String) state.getContextParameter(IntakeConstants.GENDER_SPECIFIED_BY_USER + personId, request);
...
<Script Language="JavaScript">
  ...
  function personIdentifierSearch()
  {
  	disableValidation("frmPersonSearch");
    submitValidateForm( "frmPersonSearch", "/person/PersonSearch/displayPersonIdentifierSearch" );
  }
...
<impact:validateForm name="frmPersonSearch"
	...
	<div id="pageNav">
	<ul>
		<li class="lvl2NavSelect tab">Person Search</li>
		<li class="lvl2Nav tab"><a href="javascript:personIdentifierSearch();">Identifier Search</a></li>
	</ul>
	</div>
		...
		<tr>
			<td width="13%">
				<impact:validateSelect name="cboSearchType"
					...
					codesTable="CPERSRCH" value="<%=searchType%>" colspan="10"
					tabIndex="<%=tabIndex++%>" />
			</td>
		</tr>
		<tr>
			<td width="13%">
				<impact:validateInput name="txtSzNmNameLast" type="text"
					label="Last Name" constraint="Name22" required="false"
					conditionallyRequired="false" cssClass="formInput"
					value="<%=FormattingHelper.formatString(lastNm)%>" size="21"
					maxLength="19" tabIndex="<%=tabIndex++%>" />
			</td>
		</tr>
		<tr>
			<td>
				<impact:validateInput name="txtSzNmNameFirst" type="text"
					label="First Name" constraint="Name12" required="false"
					cssClass="formInput"
					value="<%=FormattingHelper.formatString(firstNm)%>" size="21"
					maxLength="19" tabIndex="<%=tabIndex++%>" />
			</td>
		</tr>
		<tr>
			<td>
				<impact:validateInput name="txtSzNmNameMiddle" type="text"
					label="Middle Name" constraint="Name12" required="false"
					cssClass="formInput"
					value="<%=FormattingHelper.formatString(middleNm)%>" size="21"
					maxLength="19" tabIndex="<%=tabIndex++%>" />
			</td>
		</tr>
		<tr>
			<td>
				<impact:validateDate name="txtDtDtPersonBirth" label="Date of Birth"
					constraint="Date" conditionallyRequired="false"
					value="<%=FormattingHelper.formatDate(dob)%>" size="21"
					tabIndex="<%=tabIndex++%>" />
			</td>
		</tr>
		<tr>
...
<script type="text/javascript" language="JavaScript1.2">
  ...
  {
     setIsDirtyCalled(true); setValidationUrl('frmPersonSearch', '/person/PersonSearch/searchPersonSearch'); 
  }
...
<br/>
<a href="javascript:personIdentifierSearch();">Identifier Search</a>
