...
public class CoverLetterToRequesterEng extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("CoverLetterToRequesterEng", "execute");
  ...
  // Event-Contact Constants for ccf11o00, ccf21o00
