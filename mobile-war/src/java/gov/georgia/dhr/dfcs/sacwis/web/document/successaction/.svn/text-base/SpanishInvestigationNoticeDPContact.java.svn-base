...
public class SpanishInvestigationNoticeDPContact extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("SpanishInvestigationNoticeDPContact", "execute");
  ...
  // Event-Contact Constants for cfiv2000
  ...
  public final String DP_EVENT_DESCRIPTION = "Investigation Spanish Notice to Des Perp Form";
