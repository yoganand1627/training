...
public class NotifToParentSpa extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("NotifToParentSpa", "execute");
    ...
    rowccmn01uig00.setSzTxtEventDescr(DP_DESCR_AFC_NOTIF);
  ...
  // Event-Contact Constants for ccfc14o00, ccfc24o00
