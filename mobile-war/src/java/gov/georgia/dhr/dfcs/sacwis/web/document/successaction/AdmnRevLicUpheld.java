...
public class AdmnRevLicUpheld extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("AdmnRevLicUpheld", "execute");
    ...
    rowccmn01uig00.setSzTxtEventDescr(DP_DESCR_CCL_NOTIF);
  ...
  // Event-Contact Constants for clf02o00, clf01o00
