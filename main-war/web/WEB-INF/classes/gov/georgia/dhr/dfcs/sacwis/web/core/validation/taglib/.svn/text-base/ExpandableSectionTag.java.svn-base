...
/**
 * The ExpandableSectionTag class creates the HTML code which creates the expandable sections with the associated JS
 * calls and div tags
 *
 * @author Stephan P. Brauchli 11/13/2002
 */
public class ExpandableSectionTag extends BaseHtmlTag {
  /** Default Constructor. */
  public ExpandableSectionTag() {
    super();
    GrndsTrace.enterScope(ExpandableSectionTag.TRACE_TAG + ".constructor");
  ...
  protected String createOpeningHtml() {
    GrndsTrace.enterScope(ExpandableSectionTag.TRACE_TAG + ".createLabelHtml");
