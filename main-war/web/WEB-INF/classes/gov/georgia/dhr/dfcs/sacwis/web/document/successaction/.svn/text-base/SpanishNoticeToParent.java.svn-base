...
public class SpanishNoticeToParent extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("Spanish Notice To Parent", "execute");
    ...
    rowccmn01uig00.setSzTxtEventDescr(SP_PAR_EVENT_DESCRIPTION);
    rowccmn01uig00.setUlIdPerson(UserProfileHelper.getUserProfile(request).getUserID());
  ...
  // Event-Contact Constants for cfiv1900
  ...
  public final String SP_PAR_EVENT_DESCRIPTION = "Investigation Spanish Notice to Parent Form";
