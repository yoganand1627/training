...
public class NoticeToReporter extends DocumentSuccessAction {
  ...
  public void execute(HttpServletRequest request) throws Exception {
    ...
    rowccmn01uig00.setSzTxtEventDescr(REP_EVENT_DESCRIPTION);
    rowccmn01uig00.setUlIdPerson(UserProfileHelper.getUserProfile(request).getUserID());
  ...
  // Event-Contact Constants for cfiv0500
  ...
  public final String REP_EVENT_DESCRIPTION = "Investigation Notice to Reporter Form";
