...
public class ToDoHelper {
  /**
   * This method sets ToDoDetailDB into state.
   *
   * @param toDoDetailDB The <tt>ToDoDetailDB</tt> object
   * @param request      The <tt>HttpServletRequest</tt> object
   * @param state        The <tt>BaseSessionStateManager</tt> object
   */
  public static void setToDoDetailDB(ToDoDetailDB toDoDetailDB, HttpServletRequest request,
                                     BaseSessionStateManager state) {
    state.setAttribute(TODO_DETAIL_DB_KEY, toDoDetailDB, request);
  }
