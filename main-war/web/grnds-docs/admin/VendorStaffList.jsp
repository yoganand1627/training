...
<%@ page import="gov.georgia.dhr.dfcs.sacwis.web.admin.VendorStaffListConversation" %>
...
<script type="text/javascript" language="JavaScript1.2">
  ...
  <impact:validateForm
       ...
       method="post"
       action="/admin/VendorStaffList/displayVendorStaffList"
...
%>
         <tr class="<%=FormattingHelper.getRowCss( loopCount + 1 )%>" valign="center">
           ...
           <td>
	           <impact:ifThen test='<%=(screenName.equals(PORTAL_STAFF_LIST)) %>'>
	           ...
	           <impact:ifThen test='<%=(screenName.equals(PORTAL_PENDING_STAFF_LIST)) %>'>
