...
<impact:validateForm 
  name="frmCorActPlan"
  method="post"
  action="/fad/CorrectiveActionPlan/displayCorrectiveActionPlan"
  validationClass="gov.georgia.dhr.dfcs.sacwis.web.fad.CorrectiveActionPlanCustomValidation"
  pageMode="<%= pageMode %>"
...
<tr>
  <th colspan="<%= entireColspan + 1%>">Corrective Action Plan</th>
</tr>
<tr>
  <td>
    Home Type:
...
<tr>
  <td>
    ...
    %>  
    <impact:validateDate
      name="txtDtEffectFrom"
      tabIndex="<%= tabIndex++ %>"
      label="Plan is Effect From"
      size="7"
      constraint="Date"
      required="false"
...
%>
      <impact:ButtonTag
        ...
        form="frmCorActPlan"
        restrictRepost="true"
        action="/fad/CorrectiveActionPlan/saveSubmitCorrectiveActionPlan"
      />
<%
} else{
%><%= SPACES %><%
...
%>
      <impact:ButtonTag
        ...
        restrictRepost="true"
        form="frmCorActPlan"
        action="/fad/CorrectiveActionPlan/saveCorrectiveActionPlan"
      />
<%
} else{
  out.print(SPACES);
...
<impact:documentButton pageMode="<%= pageMode %>"
       ...
       <impact:document displayName="Corrective Action Plan Document"
