...
public final class CorrectiveActionPlan_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//*--------------------------------------------------------------------------------
//*  JSP Name:     Corrective Action Plan
//*  Created by:   ssubram
//*  Date Created: 06/05/08
//*
//*  Description:
//*  This JSP displays the Corrective Action Plan.
//*
//*  Change History:
...
//*--------------------------------------------------------------------------------
  ...
  String isCpaCon = "false";
  boolean isSecStCpaCon = false;
  boolean bProtectForm = (Boolean) state.getAttribute(CorrectiveActionPlanConversation.PROTECT_FORM, request);
  ...
  if (nonComplianceSO != null){
    ...
    //CPA Concurrence
    s = nonComplianceSO.getIndCpaCon();
    if(s != null && !s.equals("")){
      if (s.equalsIgnoreCase("Y")){
        isCpaCon = "true";
      }else{
...
boolean bCpaConHide = true; 
//CPA Concurrence Home should be displayed only if the home type is Non DFCS F/A Home
if (homeType.equals("Non DFCS F/A Home")){
	bCpaConHide = false;
}
...
saveAndSubmit = false;
      ...
      _jspx_th_impact_validateForm_0.setName("frmCorActPlan");
      _jspx_th_impact_validateForm_0.setMethod("post");
      _jspx_th_impact_validateForm_0.setAction("/fad/CorrectiveActionPlan/displayCorrectiveActionPlan");
      _jspx_th_impact_validateForm_0.setValidationClass("gov.georgia.dhr.dfcs.sacwis.web.fad.CorrectiveActionPlanCustomValidation");
...
if(approvalStatus){
          ...
          _jspx_th_impact_ButtonTag_0.setForm("frmCorActPlan");
...
int entireColspan = 4; //-- this must be even
          ...
          out.write("\">Corrective Action Plan</th>\r\n</tr>\r\n<tr>\r\n  <td>\r\n    Home Type:\r\n  </td>\r\n  <td>\r\n    ");
          out.print(homeType );
          out.write("\r\n  </td>\r\n</tr>\r\n<tr>\r\n  <td>\r\n    ");
    ...
    //----------------------------------
          ...
          _jspx_th_impact_validateDate_0.setLabel("Date of Achievement");
...
if (!bCpaConHide) {
    ...
    //----------------------------------
          ...
          _jspx_th_impact_validateInput_2.setName("cbxIndCpaCon");
          _jspx_th_impact_validateInput_2.setTabIndex( tabIndex++ );
          _jspx_th_impact_validateInput_2.setLabel("CPA Concurrence");
          _jspx_th_impact_validateInput_2.setType("checkbox");
          _jspx_th_impact_validateInput_2.setChecked( isCpaCon );
          _jspx_th_impact_validateInput_2.setDisabled( String.valueOf(isSecStCpaCon) );
    ...
    //----------------------------------
          ...
          _jspx_th_impact_validateTextArea_0.setLabel("Results Description");
          _jspx_th_impact_validateTextArea_0.setTitle("Results Description");
    ...
    // STGAP00009837 - change this field to be required field
          ...
          _jspx_th_impact_validateInput_3.setName( checkboxHomeViolation );
          _jspx_th_impact_validateInput_3.setValue( String.valueOf( ncPerson.getIdPerson() ) );
          _jspx_th_impact_validateInput_3.setChecked( isSelectedHV );
          ...
          _jspx_th_impact_validateInput_4.setName( checkboxAdoptiveProcess );
          _jspx_th_impact_validateInput_4.setValue( String.valueOf( ncPerson.getIdPerson() ) );
          _jspx_th_impact_validateInput_4.setChecked( isSelectedAP );
    ...
    //----------------------------------
          ...
          _jspx_th_impact_validateDate_2.setName("txtDtEffectFrom");
          _jspx_th_impact_validateDate_2.setTabIndex( tabIndex++ );
          _jspx_th_impact_validateDate_2.setLabel("Plan is Effect From");
          ...
          _jspx_th_impact_validateDate_2.setValue( effectFromDate );
    ...
    //----------------------------------
          ...
          _jspx_th_impact_validateDate_3.setName("txtDtEffectTo");
          _jspx_th_impact_validateDate_3.setTabIndex( tabIndex++ );
          _jspx_th_impact_validateDate_3.setLabel("Plan is Effect To");
          ...
          _jspx_th_impact_validateDate_3.setValue( effectToDate );
...
if(saveAndSubmit){
          ...
          _jspx_th_impact_ButtonTag_1.setForm("frmCorActPlan");
          _jspx_th_impact_ButtonTag_1.setRestrictRepost(true);
          _jspx_th_impact_ButtonTag_1.setAction("/fad/CorrectiveActionPlan/saveSubmitCorrectiveActionPlan");
...
if(save){
          ...
          _jspx_th_impact_ButtonTag_2.setForm("frmCorActPlan");
          _jspx_th_impact_ButtonTag_2.setAction("/fad/CorrectiveActionPlan/saveCorrectiveActionPlan");
  ...
  out.print(SPACES);
      ...
      if (_jspx_eval_impact_documentButton_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_impact_document_0.setDisplayName("Corrective Action Plan Document");
          _jspx_th_impact_document_0.setProtectDocument( bProtectForm  );
          _jspx_th_impact_document_0.setCheckForNewMode(true);
          _jspx_th_impact_document_0.setDocType("cfa01o00");
