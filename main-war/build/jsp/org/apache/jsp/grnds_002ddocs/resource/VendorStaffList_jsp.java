...
import gov.georgia.dhr.dfcs.sacwis.web.resource.VendorStaffListConversation;
...
/* Import xmlstructs used on the page. Xmlstructs hold the input and output data
  ...
  UserProfile user = UserProfileHelper.getUserProfile ( request );
      ...
      _jspx_th_impact_validateForm_0.setAction("/resource/VendorStaffList/displayVendorStaffList");
...
else
{
   for (Iterator<RetrieveVendorStaffListBean> it = retrieveVendorStaffList.iterator(); it.hasNext();) {               
        RetrieveVendorStaffListBean resource = it.next();
              ...
              _jspx_th_impact_ifThen_0.setTest((screenName.equals(SHINES_STAFF_LIST)) );
              ...
              _jspx_th_impact_ifThen_1.setTest((screenName.equals(SHINES_PENDING_STAFF_LIST)) );
              ...
              _jspx_th_impact_ifThen_2.setTest((screenName.equals(SHINES_PENDING_ADMIN_LIST)) );
              ...
              if (_jspx_eval_impact_ifThen_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  out.write("\r\n\t           <a href=\"javascript:displayPendingPortalAdminDetail('");
                  out.print(FormattingHelper.formatString(String.valueOf(resource.getUlIdUser())));
                  out.write("')\">");
                  out.print(FormattingHelper.formatString(resource.getSzStaffName()));
                  out.write("</a>\r\n\t           ");
              ...
              _jspx_th_impact_ifThen_3.setTest( (resource.getUlIdResource()!=null));
              ...
              _jspx_th_impact_ifThen_4.setTest((resource.getUlIdResource()==null) );
              ...
              _jspx_th_impact_ifThen_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_impact_pagination_0);
              _jspx_th_impact_ifThen_5.setTest( (resource.getDtStart()!=null));
              ...
              _jspx_th_impact_ifThen_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_impact_pagination_0);
              _jspx_th_impact_ifThen_6.setTest((resource.getDtStart()==null) );
              ...
              _jspx_th_impact_ifThen_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_impact_pagination_0);
              _jspx_th_impact_ifThen_7.setTest( (resource.getDtEnd()!=null));
              ...
              _jspx_th_impact_ifThen_8.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_impact_pagination_0);
              _jspx_th_impact_ifThen_8.setTest((resource.getDtEnd()==null) );
