...
public abstract class GlobalData {
  ...
  private static final String ID_PARENT_RSRC = "ulIdParentRsrc";
  private static final String ID_PLCMT_EVENT = "ulIdPlcmtEvent";
...
//  private static final String ID_PARENT_RSRC = "ulIdParentRsrc"
    globalData.append("Parent Resource: ").append(GlobalData.getUlIdParentRsrcAsString(request)).append(", \n");
//  private static final String ID_PLCMT_EVENT = "ulIdPlcmtEvent"
    globalData.append("Placement Event: ").append(GlobalData.getUlIdPlcmtEventAsString(request)).append(", \n");
...
//  }
  ...
  /**
   * Set parent resource for facilities and homes
   *
   * @param ulIdParentRsrc param
   */
  public static void setUlIdParentRsrc(int ulIdParentRsrc, HttpServletRequest request) {
    BaseSessionStateManager state = getState(request);
    state.setContextParameter(ID_PARENT_RSRC, String.valueOf(ulIdParentRsrc), request);
  }
  
  /**
   * Get the parent resource Id from the global data store
   *
   * @param request param
   * @return int - resource id
   */
  public static int getUlIdParentRsrc(HttpServletRequest request) {
    return getParameterAsInt(ID_PARENT_RSRC, request);
  }
   ...
   * @return String - resource ID
   */
  public static String getUlIdParentRsrcAsString(HttpServletRequest request) {
    return getParameterAsString(ID_PARENT_RSRC, request);
  }
  /**
   * Sets the global placement event for Portal Child Detail
   *
   * @param ulIdPlcmtEvent param
   */
  public static void setUlIdPlcmtEvent(int ulIdPlcmtEvent, HttpServletRequest request) {
    BaseSessionStateManager state = getState(request);
    state.setContextParameter(ID_PLCMT_EVENT, String.valueOf(ulIdPlcmtEvent), request);
  }
  
  /**
   * Get the global placement event for Portal Child Detail
   *
   * @param request param
   * @return int - id placement event
   */
  public static int getUlIdPlcmtEvent(HttpServletRequest request) {
    return getParameterAsInt(ID_PLCMT_EVENT, request);
  }
   ...
   *
   * @param request param
   * @return String - id placement event
   */
  public static String getUlIdPlcmtEventAsString(HttpServletRequest request) {
    return getParameterAsString(ID_PLCMT_EVENT, request);
  }
