...
public class NotifToReqSpa extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("NotifToReqSpa", "execute");
  ...
  // Event-Contact Constants for ccfc16o00
