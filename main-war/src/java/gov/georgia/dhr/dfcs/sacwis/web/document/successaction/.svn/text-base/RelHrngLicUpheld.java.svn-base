...
public class RelHrngLicUpheld extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("RelHrngLicUpheld", "execute");
  ...
  // Event-Contact Constants for clf03o00
