...
public class CoverLetterToRequesterSpa extends DocumentSuccessAction {

  public void execute(HttpServletRequest request) throws Exception {
    PerformanceTrace performanceTrace = new PerformanceTrace("CoverLetterToRequesterSpa", "execute");
    ...
    rowccmn01uig00.setSzTxtEventDescr(DP_DESCR_COV_LET);
  ...
  // Event-Contact Constants for ccf13o00, ccf23o00
  ...
  public final String DP_DESCR_COV_LET = "Notice to Person Reviewed";
  public final String DP_DESCR_NOTIF = "Notice to Reporter";
  public final String DP_DESCR_AFC_NOTIF = "Notice to Requester";
  public final String DP_DESCR_CCL_NOTIF = "Notice to Requester";
