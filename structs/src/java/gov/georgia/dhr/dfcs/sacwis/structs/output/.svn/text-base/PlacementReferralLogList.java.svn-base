...
/**
 * This list is a part of PlacementReferralLogRetrieveSO, which holds the list of Placement Referral log.
 * This object holds resource Id.  
 *
 * @author Lata Lokhande 02/12/2007
 */
public class PlacementReferralLogList implements Serializable {
...
public PlacementReferralLogList(){
  this.cdPersonSex = "";
