...
public class RelativeCareAssessmentBean implements Serializable {
  ...
  protected ROWCCMN45DO rowccmn45do = null;
  private int idStage;
  ...
  public void setCdReqFuncCd(String reqFunc){
    this.cdReqFuncCd=reqFunc;
  }
  public String getCdReqFuncCd(){
    return this.cdReqFuncCd;
  }
  
  public void setCdStage(String stage){
    this.cdStage = stage;
  }
  ...
  /**
   * @return the indSupportOptions
   */
  public String getIndSupportOptions() {
    return indSupportOptions;
  }
  /**
   * @param indSupportOptions the indSupportOptions to set
   */
  public void setIndSupportOptions(String indSupportOptions) {
    this.indSupportOptions = indSupportOptions;
  }
  /**
   * @return the indWillingToAcceptChild
   */
  public String getIndWillingToAcceptChild() {
    return indWillingToAcceptChild;
  }
  /**
   * @param indWillingToAcceptChild the indWillingToAcceptChild to set
   */
  public void setIndWillingToAcceptChild(String indWillingToAcceptChild) {
    this.indWillingToAcceptChild = indWillingToAcceptChild;
  }
  /**
   * @return the rowccmn45do
   */
  public ROWCCMN45DO getRowccmn45do() {
    return rowccmn45do;
  }
  /**
   * @param rowccmn45do the rowccmn45do to set
   */
