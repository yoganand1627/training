...
/**
 * Class StagePersonLinkSaveSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class StagePersonLinkSaveSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public StagePersonLinkSaveSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.StagePersonLinkSaveSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.StagePersonLinkSaveSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.StagePersonLinkSaveSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.StagePersonLinkSaveSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.StagePersonLinkSaveSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.StagePersonLinkSaveSI unmarshal(java.io.Reader) 
