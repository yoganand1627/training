...
implements java.io.Serializable
{
    ...
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.SzNmPersonFull_ARRAY()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._szNmPersonFullList.size() >= 200) {
            throw new IndexOutOfBoundsException("addSzNmPersonFull has a maximum of 200");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.SzNmPersonFull_ARRAY
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.SzNmPersonFull_ARRAY unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.SzNmPersonFull_ARRAY) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.SzNmPersonFull_ARRAY.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.SzNmPersonFull_ARRAY unmarshal(java.io.Reader) 
