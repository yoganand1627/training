...
/**
 * Class CINV04SO_OTHER_RELATIONSHIP.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class CINV04SO_OTHER_RELATIONSHIP extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public CINV04SO_OTHER_RELATIONSHIP() 
     {
        super();
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.CINV04SO_OTHER_RELATIONSHIP
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.CINV04SO_OTHER_RELATIONSHIP unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.CINV04SO_OTHER_RELATIONSHIP) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.CINV04SO_OTHER_RELATIONSHIP.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.CINV04SO_OTHER_RELATIONSHIP unmarshal(java.io.Reader) 
