...
/**
 * Class CreateCallOutStruct.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class CreateCallOutStruct extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public CreateCallOutStruct() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.CreateCallOutStruct()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.CreateCallOutStruc
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.CreateCallOutStruct unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.CreateCallOutStruct) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.CreateCallOutStruct.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.CreateCallOutStruct unmarshal(java.io.Reader) 
