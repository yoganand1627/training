...
/**
 * Class UlIdEvent_ARRAY_CCFC33S.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdEvent_ARRAY_CCFC33S extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdEvent_ARRAY_CCFC33S() 
     {
        super();
        this._ulIdEventList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CCFC33S()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdEventList.size() >= 2500) {
            throw new IndexOutOfBoundsException("addUlIdEvent has a maximum of 2500");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CCFC33S
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CCFC33S unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CCFC33S) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CCFC33S.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CCFC33S unmarshal(java.io.Reader) 
