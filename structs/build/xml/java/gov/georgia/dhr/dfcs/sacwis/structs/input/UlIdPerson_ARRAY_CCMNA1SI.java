...
/**
 * Class UlIdPerson_ARRAY_CCMNA1SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdPerson_ARRAY_CCMNA1SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdPerson_ARRAY_CCMNA1SI() 
     {
        super();
        this._ulIdPersonList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMNA1SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdPersonList.size() >= 20) {
            throw new IndexOutOfBoundsException("addUlIdPerson has a maximum of 20");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMNA1SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMNA1SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMNA1SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMNA1SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMNA1SI unmarshal(java.io.Reader) 
