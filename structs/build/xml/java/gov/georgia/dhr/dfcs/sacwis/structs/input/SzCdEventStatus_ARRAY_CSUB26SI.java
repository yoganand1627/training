...
/**
 * Class SzCdEventStatus_ARRAY_CSUB26SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SzCdEventStatus_ARRAY_CSUB26SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public SzCdEventStatus_ARRAY_CSUB26SI() 
     {
        super();
        this._szCdEventStatusList = new java.util.ArrayList<java.lang.String>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdEventStatus_ARRAY_CSUB26SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._szCdEventStatusList.size() >= 3) {
            throw new IndexOutOfBoundsException("addSzCdEventStatus has a maximum of 3");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdEventStatus_ARRAY_CSUB26SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdEventStatus_ARRAY_CSUB26SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdEventStatus_ARRAY_CSUB26SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdEventStatus_ARRAY_CSUB26SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdEventStatus_ARRAY_CSUB26SI unmarshal(java.io.Reader) 
