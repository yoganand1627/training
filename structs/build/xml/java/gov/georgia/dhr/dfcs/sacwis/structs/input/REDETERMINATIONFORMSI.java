...
/**
 * Class REDETERMINATIONFORMSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class REDETERMINATIONFORMSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public REDETERMINATIONFORMSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.REDETERMINATIONFORMSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.REDETERMINATIONFORMSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.REDETERMINATIONFORMSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.REDETERMINATIONFORMSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.REDETERMINATIONFORMSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.REDETERMINATIONFORMSI unmarshal(java.io.Reader) 
