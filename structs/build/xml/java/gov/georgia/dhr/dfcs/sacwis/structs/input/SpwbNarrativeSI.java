...
/**
 * Class SpwbNarrativeSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SpwbNarrativeSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public SpwbNarrativeSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SpwbNarrativeSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.SpwbNarrativeSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.SpwbNarrativeSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.SpwbNarrativeSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.SpwbNarrativeSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SpwbNarrativeSI unmarshal(java.io.Reader) 
