...
/**
 * Class SzCdOnCallCounty_ARRAY_CCMN06SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SzCdOnCallCounty_ARRAY_CCMN06SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public SzCdOnCallCounty_ARRAY_CCMN06SI() 
     {
        super();
        this._szCdOnCallCountyList = new java.util.ArrayList<java.lang.String>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOnCallCounty_ARRAY_CCMN06SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._szCdOnCallCountyList.size() >= 350) {
            throw new IndexOutOfBoundsException("addSzCdOnCallCounty has a maximum of 350");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOnCallCounty_ARRAY_CCMN06SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOnCallCounty_ARRAY_CCMN06SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOnCallCounty_ARRAY_CCMN06SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOnCallCounty_ARRAY_CCMN06SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOnCallCounty_ARRAY_CCMN06SI unmarshal(java.io.Reader) 
