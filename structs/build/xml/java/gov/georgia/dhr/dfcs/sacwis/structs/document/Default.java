...
public class Default implements java.io.Serializable {
    ...
    public Default() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.document.Default()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.document.Default
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.document.Default unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.document.Default) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.document.Default.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.document.Default unmarshal(java.io.Reader) 
