...
/**
 * Class TsLastUpdate_ARRAY.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class TsLastUpdate_ARRAY extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public TsLastUpdate_ARRAY() 
     {
        super();
        this._tsLastUpdateList = new java.util.ArrayList<java.util.Date>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._tsLastUpdateList.size() >= 50) {
            throw new IndexOutOfBoundsException("addTsLastUpdate has a maximum of 50");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY unmarshal(java.io.Reader) 
