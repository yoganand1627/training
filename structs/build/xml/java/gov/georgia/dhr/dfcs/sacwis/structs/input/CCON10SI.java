...
public class CCON10SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    /**
     * Field _ROWCCON10SIG00_ARRAY
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCON10SIG00_ARRAY _ROWCCON10SIG00_ARRAY;
    ...
    public CCON10SI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CCON10SI()
    ...
    /**
     * Returns the value of field 'ROWCCON10SIG00_ARRAY'.
     * 
     * @return the value of field 'ROWCCON10SIG00_ARRAY'.
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCON10SIG00_ARRAY getROWCCON10SIG00_ARRAY()
    {
        return this._ROWCCON10SIG00_ARRAY;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCON10SIG00_ARRAY getROWCCON10SIG00_ARRAY() 
    ...
    /**
     * Sets the value of field 'ROWCCON10SIG00_ARRAY'.
     * 
     * @param ROWCCON10SIG00_ARRAY the value of field
     * 'ROWCCON10SIG00_ARRAY'.
     */
    public void setROWCCON10SIG00_ARRAY(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCON10SIG00_ARRAY ROWCCON10SIG00_ARRAY)
    {
        this._ROWCCON10SIG00_ARRAY = ROWCCON10SIG00_ARRAY;
    } //-- void setROWCCON10SIG00_ARRAY(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCON10SIG00_ARRAY) 
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.CCON10SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.CCON10SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.CCON10SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.CCON10SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CCON10SI unmarshal(java.io.Reader) 
