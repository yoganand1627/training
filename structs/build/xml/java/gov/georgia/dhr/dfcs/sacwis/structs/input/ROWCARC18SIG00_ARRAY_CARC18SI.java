...
/**
 * Class ROWCARC18SIG00_ARRAY_CARC18SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ROWCARC18SIG00_ARRAY_CARC18SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public ROWCARC18SIG00_ARRAY_CARC18SI() 
     {
        super();
        this._ROWCARC18SIG00List = new java.util.ArrayList<gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00_ARRAY_CARC18SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ROWCARC18SIG00List.size() >= 10) {
            throw new IndexOutOfBoundsException("addROWCARC18SIG00 has a maximum of 10");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00_ARRAY_CARC18SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00_ARRAY_CARC18SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00_ARRAY_CARC18SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00_ARRAY_CARC18SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCARC18SIG00_ARRAY_CARC18SI unmarshal(java.io.Reader) 
