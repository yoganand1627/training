...
implements java.io.Serializable
{
    ...
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdStage_ARRAY()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdStageList.size() >= 20) {
            throw new IndexOutOfBoundsException("addUlIdStage has a maximum of 20");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdStage_ARRAY
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdStage_ARRAY unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdStage_ARRAY) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdStage_ARRAY.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdStage_ARRAY unmarshal(java.io.Reader) 
