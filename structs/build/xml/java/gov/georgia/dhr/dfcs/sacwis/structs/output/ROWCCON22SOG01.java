...
/**
 * Class ROWCCON22SOG01.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ROWCCON22SOG01 extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    /**
     * Field _lAmtSvcAuthDtlAmtUsed
     */
    private double _lAmtSvcAuthDtlAmtUsed;

    /**
     * keeps track of state for field: _lAmtSvcAuthDtlAmtUsed
     */
    private boolean _has_lAmtSvcAuthDtlAmtUsed;
    ...
    public ROWCCON22SOG01() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCON22SOG01()
    ...
    /**
     */
    public void deleteLAmtSvcAuthDtlAmtUsed()
    {
        this._has_lAmtSvcAuthDtlAmtUsed= false;
    } //-- void deleteLAmtSvcAuthDtlAmtUsed() 
    ...
    /**
     * Returns the value of field 'lAmtSvcAuthDtlAmtUsed'.
     * 
     * @return the value of field 'LAmtSvcAuthDtlAmtUsed'.
     */
    public double getLAmtSvcAuthDtlAmtUsed()
    {
        return this._lAmtSvcAuthDtlAmtUsed;
    } //-- double getLAmtSvcAuthDtlAmtUsed() 
    ...
    /**
     * Method hasLAmtSvcAuthDtlAmtUsed
     * 
     * 
     * 
     * @return true if at least one LAmtSvcAuthDtlAmtUsed has been
     * added
     */
    public boolean hasLAmtSvcAuthDtlAmtUsed()
    {
        return this._has_lAmtSvcAuthDtlAmtUsed;
    } //-- boolean hasLAmtSvcAuthDtlAmtUsed() 
    ...
    /**
     * Sets the value of field 'lAmtSvcAuthDtlAmtUsed'.
     * 
     * @param lAmtSvcAuthDtlAmtUsed the value of field
     * 'lAmtSvcAuthDtlAmtUsed'.
     */
    public void setLAmtSvcAuthDtlAmtUsed(double lAmtSvcAuthDtlAmtUsed)
    {
        this._lAmtSvcAuthDtlAmtUsed = lAmtSvcAuthDtlAmtUsed;
        this._has_lAmtSvcAuthDtlAmtUsed = true;
    } //-- void setLAmtSvcAuthDtlAmtUsed(double) 
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCON22SOG01
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCON22SOG01 unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCON22SOG01) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCON22SOG01.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCON22SOG01 unmarshal(java.io.Reader) 
