...
/**
 * Class AdoptAssistMemSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class AdoptAssistMemSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public AdoptAssistMemSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.AdoptAssistMemSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.AdoptAssistMemSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.AdoptAssistMemSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.AdoptAssistMemSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.AdoptAssistMemSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.AdoptAssistMemSI unmarshal(java.io.Reader) 
