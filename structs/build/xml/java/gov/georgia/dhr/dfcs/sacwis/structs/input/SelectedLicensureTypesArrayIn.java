...
/**
 * Class SelectedLicensureTypesArrayIn.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SelectedLicensureTypesArrayIn extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public SelectedLicensureTypesArrayIn() 
     {
        super();
        this._szPrgmLicensureTypeList = new java.util.ArrayList<java.lang.String>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SelectedLicensureTypesArrayIn()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.SelectedLicensureTypesArrayIn
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.SelectedLicensureTypesArrayIn unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.SelectedLicensureTypesArrayIn) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.SelectedLicensureTypesArrayIn.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SelectedLicensureTypesArrayIn unmarshal(java.io.Reader) 
