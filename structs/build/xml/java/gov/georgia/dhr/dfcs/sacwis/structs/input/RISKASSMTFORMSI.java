...
/**
 * Class RISKASSMTFORMSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class RISKASSMTFORMSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public RISKASSMTFORMSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.RISKASSMTFORMSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.RISKASSMTFORMSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.RISKASSMTFORMSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.RISKASSMTFORMSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.RISKASSMTFORMSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.RISKASSMTFORMSI unmarshal(java.io.Reader) 
