...
implements java.io.Serializable
{
    ...
    public FacDetailEntStruct() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.FacDetailEntStruct()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.FacDetailEntStruct
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.FacDetailEntStruct unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.FacDetailEntStruct) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.FacDetailEntStruct.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.FacDetailEntStruct unmarshal(java.io.Reader) 
