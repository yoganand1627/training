...
/**
 * Class AllegationEvidence.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class AllegationEvidence extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.AllegationEvidence
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.AllegationEvidence unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.AllegationEvidence) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.AllegationEvidence.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.AllegationEvidence unmarshal(java.io.Reader) 
