...
public class CCMN03UI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    /**
     * Field _ROWCCMN03UIG00_ARRAY
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCMN03UIG00_ARRAY _ROWCCMN03UIG00_ARRAY;
    ...
    public CCMN03UI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CCMN03UI()
    ...
    /**
     * Returns the value of field 'ROWCCMN03UIG00_ARRAY'.
     * 
     * @return the value of field 'ROWCCMN03UIG00_ARRAY'.
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCMN03UIG00_ARRAY getROWCCMN03UIG00_ARRAY()
    {
        return this._ROWCCMN03UIG00_ARRAY;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCMN03UIG00_ARRAY getROWCCMN03UIG00_ARRAY() 
    ...
    /**
     * Sets the value of field 'ROWCCMN03UIG00_ARRAY'.
     * 
     * @param ROWCCMN03UIG00_ARRAY the value of field
     * 'ROWCCMN03UIG00_ARRAY'.
     */
    public void setROWCCMN03UIG00_ARRAY(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCMN03UIG00_ARRAY ROWCCMN03UIG00_ARRAY)
    {
        this._ROWCCMN03UIG00_ARRAY = ROWCCMN03UIG00_ARRAY;
    } //-- void setROWCCMN03UIG00_ARRAY(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCCMN03UIG00_ARRAY) 
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.CCMN03UI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.CCMN03UI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.CCMN03UI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.CCMN03UI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CCMN03UI unmarshal(java.io.Reader) 
