...
/**
 * Class UlIdPerson_ARRAY_CCFC33S.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdPerson_ARRAY_CCFC33S extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdPerson_ARRAY_CCFC33S() 
     {
        super();
        this._ulIdPersonList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdPerson_ARRAY_CCFC33S()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdPersonList.size() >= 4000) {
            throw new IndexOutOfBoundsException("addUlIdPerson has a maximum of 4000");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdPerson_ARRAY_CCFC33S
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdPerson_ARRAY_CCFC33S unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdPerson_ARRAY_CCFC33S) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdPerson_ARRAY_CCFC33S.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdPerson_ARRAY_CCFC33S unmarshal(java.io.Reader) 
