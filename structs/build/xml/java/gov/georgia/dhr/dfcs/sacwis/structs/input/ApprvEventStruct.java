...
/**
 * Class ApprvEventStruct.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ApprvEventStruct extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public ApprvEventStruct() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ApprvEventStruct()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.ApprvEventStruct
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.ApprvEventStruct unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.ApprvEventStruct) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.ApprvEventStruct.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ApprvEventStruct unmarshal(java.io.Reader) 
