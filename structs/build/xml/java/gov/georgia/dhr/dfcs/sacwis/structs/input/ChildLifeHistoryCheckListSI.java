...
/**
 * Class ChildLifeHistoryCheckListSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ChildLifeHistoryCheckListSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public ChildLifeHistoryCheckListSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ChildLifeHistoryCheckListSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.ChildLifeHistoryCheckListSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.ChildLifeHistoryCheckListSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.ChildLifeHistoryCheckListSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.ChildLifeHistoryCheckListSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ChildLifeHistoryCheckListSI unmarshal(java.io.Reader) 
