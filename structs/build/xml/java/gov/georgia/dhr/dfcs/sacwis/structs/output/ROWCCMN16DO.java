...
public class ROWCCMN16DO extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    /**
     * Field _ulCountOfCounty
     */
    private int _ulCountOfCounty;

    /**
     * keeps track of state for field: _ulCountOfCounty
     */
    private boolean _has_ulCountOfCounty;
    ...
    public ROWCCMN16DO() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCMN16DO()
    ...
    /**
     */
    public void deleteUlCountOfCounty()
    {
        this._has_ulCountOfCounty= false;
    } //-- void deleteUlCountOfCounty() 
    ...
    /**
     * Returns the value of field 'ulCountOfCounty'.
     * 
     * @return the value of field 'UlCountOfCounty'.
     */
    public int getUlCountOfCounty()
    {
        return this._ulCountOfCounty;
    } //-- int getUlCountOfCounty() 
    ...
    /**
     * Method hasUlCountOfCounty
     * 
     * 
     * 
     * @return true if at least one UlCountOfCounty has been added
     */
    public boolean hasUlCountOfCounty()
    {
        return this._has_ulCountOfCounty;
    } //-- boolean hasUlCountOfCounty() 
    ...
    /**
     * Sets the value of field 'ulCountOfCounty'.
     * 
     * @param ulCountOfCounty the value of field 'ulCountOfCounty'.
     */
    public void setUlCountOfCounty(int ulCountOfCounty)
    {
        this._ulCountOfCounty = ulCountOfCounty;
        this._has_ulCountOfCounty = true;
    } //-- void setUlCountOfCounty(int) 
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCMN16DO
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCMN16DO unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCMN16DO) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCMN16DO.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.ROWCCMN16DO unmarshal(java.io.Reader) 
