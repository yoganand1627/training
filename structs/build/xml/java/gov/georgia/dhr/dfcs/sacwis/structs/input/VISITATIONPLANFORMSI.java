...
/**
 * Class VISITATIONPLANFORMSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class VISITATIONPLANFORMSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public VISITATIONPLANFORMSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.VISITATIONPLANFORMSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.VISITATIONPLANFORMS
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.VISITATIONPLANFORMSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.VISITATIONPLANFORMSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.VISITATIONPLANFORMSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.VISITATIONPLANFORMSI unmarshal(java.io.Reader) 
