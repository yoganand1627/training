...
/**
 * Class UlIdPerson_ARRAY_CCFC42SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdPerson_ARRAY_CCFC42SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdPerson_ARRAY_CCFC42SI() 
     {
        super();
        this._ulIdPersonList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCFC42SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdPersonList.size() >= 2) {
            throw new IndexOutOfBoundsException("addUlIdPerson has a maximum of 2");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCFC42SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCFC42SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCFC42SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCFC42SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCFC42SI unmarshal(java.io.Reader) 
