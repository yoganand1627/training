...
/**
 * Class SERVICEAUTHREFSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SERVICEAUTHREFSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public SERVICEAUTHREFSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SERVICEAUTHREFSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.SERVICEAUTHREFSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.SERVICEAUTHREFSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.SERVICEAUTHREFSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.SERVICEAUTHREFSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SERVICEAUTHREFSI unmarshal(java.io.Reader) 
