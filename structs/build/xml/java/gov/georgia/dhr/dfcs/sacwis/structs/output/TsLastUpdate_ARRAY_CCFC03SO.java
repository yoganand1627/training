...
/**
 * Class TsLastUpdate_ARRAY_CCFC03SO.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class TsLastUpdate_ARRAY_CCFC03SO extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public TsLastUpdate_ARRAY_CCFC03SO() 
     {
        super();
        this._tsLastUpdateList = new java.util.ArrayList<java.util.Date>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY_CCFC03SO()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY_CCFC03SO
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY_CCFC03SO unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY_CCFC03SO) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY_CCFC03SO.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.TsLastUpdate_ARRAY_CCFC03SO unmarshal(java.io.Reader) 
