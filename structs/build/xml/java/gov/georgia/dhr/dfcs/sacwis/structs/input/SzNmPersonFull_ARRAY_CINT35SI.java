...
/**
 * Class SzNmPersonFull_ARRAY_CINT35SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class SzNmPersonFull_ARRAY_CINT35SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public SzNmPersonFull_ARRAY_CINT35SI() 
     {
        super();
        this._szNmPersonFullList = new java.util.ArrayList<java.lang.String>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzNmPersonFull_ARRAY_CINT35SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._szNmPersonFullList.size() >= 30) {
            throw new IndexOutOfBoundsException("addSzNmPersonFull has a maximum of 30");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.SzNmPersonFull_ARRAY_CINT35SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.SzNmPersonFull_ARRAY_CINT35SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.SzNmPersonFull_ARRAY_CINT35SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.SzNmPersonFull_ARRAY_CINT35SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzNmPersonFull_ARRAY_CINT35SI unmarshal(java.io.Reader) 
