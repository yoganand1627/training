...
/**
 * Class UlIdPerson_ARRAY_CCMN23SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdPerson_ARRAY_CCMN23SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdPerson_ARRAY_CCMN23SI() 
     {
        super();
        this._ulIdPersonList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN23SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdPersonList.size() >= 6) {
            throw new IndexOutOfBoundsException("addUlIdPerson has a maximum of 6");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN23SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN23SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN23SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN23SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN23SI unmarshal(java.io.Reader) 
