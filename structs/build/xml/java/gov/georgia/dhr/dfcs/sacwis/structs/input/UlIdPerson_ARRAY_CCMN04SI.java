...
/**
 * Class UlIdPerson_ARRAY_CCMN04SI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdPerson_ARRAY_CCMN04SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdPerson_ARRAY_CCMN04SI() 
     {
        super();
        this._ulIdPersonList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN04SI()
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        if (this._ulIdPersonList.size() >= 7) {
            throw new IndexOutOfBoundsException("addUlIdPerson has a maximum of 7");
        }
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN04SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN04SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN04SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN04SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.UlIdPerson_ARRAY_CCMN04SI unmarshal(java.io.Reader) 
