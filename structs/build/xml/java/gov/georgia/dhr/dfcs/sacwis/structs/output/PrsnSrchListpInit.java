...
/**
 * Class PrsnSrchListpInit.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class PrsnSrchListpInit extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.PrsnSrchListpInit
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.PrsnSrchListpInit unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.PrsnSrchListpInit) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.PrsnSrchListpInit.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.PrsnSrchListpInit unmarshal(java.io.Reader) 
