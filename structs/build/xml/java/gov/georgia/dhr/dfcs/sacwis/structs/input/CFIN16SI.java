...
public class CFIN16SI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    /**
     * Field _ROWCFIN16SIG00_ARRAY
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCFIN16SIG00_ARRAY _ROWCFIN16SIG00_ARRAY;
    ...
    public CFIN16SI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CFIN16SI()
    ...
    /**
     * Returns the value of field 'ROWCFIN16SIG00_ARRAY'.
     * 
     * @return the value of field 'ROWCFIN16SIG00_ARRAY'.
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCFIN16SIG00_ARRAY getROWCFIN16SIG00_ARRAY()
    {
        return this._ROWCFIN16SIG00_ARRAY;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCFIN16SIG00_ARRAY getROWCFIN16SIG00_ARRAY() 
    ...
    /**
     * Sets the value of field 'ROWCFIN16SIG00_ARRAY'.
     * 
     * @param ROWCFIN16SIG00_ARRAY the value of field
     * 'ROWCFIN16SIG00_ARRAY'.
     */
    public void setROWCFIN16SIG00_ARRAY(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCFIN16SIG00_ARRAY ROWCFIN16SIG00_ARRAY)
    {
        this._ROWCFIN16SIG00_ARRAY = ROWCFIN16SIG00_ARRAY;
    } //-- void setROWCFIN16SIG00_ARRAY(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCFIN16SIG00_ARRAY) 
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.CFIN16SI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.CFIN16SI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.CFIN16SI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.CFIN16SI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CFIN16SI unmarshal(java.io.Reader) 
