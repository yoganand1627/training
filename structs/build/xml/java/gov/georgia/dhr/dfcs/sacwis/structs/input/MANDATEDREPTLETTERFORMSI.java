...
/**
 * Class MANDATEDREPTLETTERFORMSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class MANDATEDREPTLETTERFORMSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public MANDATEDREPTLETTERFORMSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.MANDATEDREPTLETTERFORMSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.MANDATEDREPTLETTERFORMSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.MANDATEDREPTLETTERFORMSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.MANDATEDREPTLETTERFORMSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.MANDATEDREPTLETTERFORMSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.MANDATEDREPTLETTERFORMSI unmarshal(java.io.Reader) 
