...
/**
 * Class CONTACTVISITLOGSI.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class CONTACTVISITLOGSI extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public CONTACTVISITLOGSI() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CONTACTVISITLOGSI()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.CONTACTVISITLOGSI
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.CONTACTVISITLOGSI unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.CONTACTVISITLOGSI) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.CONTACTVISITLOGSI.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CONTACTVISITLOGSI unmarshal(java.io.Reader) 
