...
implements java.io.Serializable
{
    ...
    public MUpdIDInStruct() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.MUpdIDInStruct()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.MUpdIDInStruct
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.MUpdIDInStruct unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.MUpdIDInStruct) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.MUpdIDInStruct.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.MUpdIDInStruct unmarshal(java.io.Reader) 
