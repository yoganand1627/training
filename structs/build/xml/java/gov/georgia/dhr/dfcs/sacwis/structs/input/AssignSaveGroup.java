...
/**
 * Class AssignSaveGroup.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class AssignSaveGroup extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public AssignSaveGroup() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.AssignSaveGroup()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.AssignSaveGroup
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.AssignSaveGroup unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.AssignSaveGroup) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.AssignSaveGroup.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.AssignSaveGroup unmarshal(java.io.Reader) 
