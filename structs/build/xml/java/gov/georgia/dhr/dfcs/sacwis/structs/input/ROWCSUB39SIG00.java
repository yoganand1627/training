...
/**
 * Class ROWCSUB39SIG00.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ROWCSUB39SIG00 extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    /**
     * Field _outcome_Array
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.Outcome_Array _outcome_Array;

    /**
     * Field _courtLanguage_Array
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.CourtLanguage_Array _courtLanguage_Array;

    /**
     * Field _attendee_Array
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.Attendee_Array _attendee_Array;

    /**
     * Field _szCdOutcome_Array
     */
    private gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOutcome_Array _szCdOutcome_Array;
    ...
    public ROWCSUB39SIG00() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCSUB39SIG00()
    ...
    /**
     * Returns the value of field 'attendee_Array'.
     * 
     * @return the value of field 'Attendee_Array'.
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.Attendee_Array getAttendee_Array()
    {
        return this._attendee_Array;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.Attendee_Array getAttendee_Array() 
    ...
    /**
     * Returns the value of field 'courtLanguage_Array'.
     * 
     * @return the value of field 'CourtLanguage_Array'.
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.CourtLanguage_Array getCourtLanguage_Array()
    {
        return this._courtLanguage_Array;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.CourtLanguage_Array getCourtLanguage_Array() 
    ...
    /**
     * Returns the value of field 'outcome_Array'.
     * 
     * @return the value of field 'Outcome_Array'.
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.Outcome_Array getOutcome_Array()
    {
        return this._outcome_Array;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.Outcome_Array getOutcome_Array() 
     ...
     */
    public gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOutcome_Array getSzCdOutcome_Array()
    {
        return this._szCdOutcome_Array;
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOutcome_Array getSzCdOutcome_Array() 
    ...
    /**
     * Sets the value of field 'attendee_Array'.
     * 
     * @param attendee_Array the value of field 'attendee_Array'.
     */
    public void setAttendee_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.Attendee_Array attendee_Array)
    {
        this._attendee_Array = attendee_Array;
    } //-- void setAttendee_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.Attendee_Array) 
    ...
    /**
     * Sets the value of field 'courtLanguage_Array'.
     * 
     * @param courtLanguage_Array the value of field
     * 'courtLanguage_Array'.
     */
    public void setCourtLanguage_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.CourtLanguage_Array courtLanguage_Array)
    {
        this._courtLanguage_Array = courtLanguage_Array;
    } //-- void setCourtLanguage_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.CourtLanguage_Array) 
    ...
    /**
     * Sets the value of field 'outcome_Array'.
     * 
     * @param outcome_Array the value of field 'outcome_Array'.
     */
    public void setOutcome_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.Outcome_Array outcome_Array)
    {
        this._outcome_Array = outcome_Array;
    } //-- void setOutcome_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.Outcome_Array) 
     ...
     * 'szCdOutcome_Array'.
     */
    public void setSzCdOutcome_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOutcome_Array szCdOutcome_Array)
    {
        this._szCdOutcome_Array = szCdOutcome_Array;
    } //-- void setSzCdOutcome_Array(gov.georgia.dhr.dfcs.sacwis.structs.input.SzCdOutcome_Array) 
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCSUB39SIG00
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCSUB39SIG00 unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCSUB39SIG00) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCSUB39SIG00.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.input.ROWCSUB39SIG00 unmarshal(java.io.Reader) 
