...
/**
 * Class PersonInfoStruct.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class PersonInfoStruct extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public PersonInfoStruct() 
     {
        super();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.PersonInfoStruct()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.PersonInfoStruct
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.PersonInfoStruct unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.PersonInfoStruct) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.PersonInfoStruct.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.PersonInfoStruct unmarshal(java.io.Reader) 
