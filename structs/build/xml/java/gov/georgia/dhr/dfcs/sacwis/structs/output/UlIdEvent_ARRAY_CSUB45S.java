...
/**
 * Class UlIdEvent_ARRAY_CSUB45S.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class UlIdEvent_ARRAY_CSUB45S extends gov.georgia.dhr.dfcs.sacwis.core.xml.XmlValueBean 
implements java.io.Serializable
{
    ...
    public UlIdEvent_ARRAY_CSUB45S() 
     {
        super();
        this._ulIdEventList = new java.util.ArrayList<Integer>();
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CSUB45S()
     ...
     * gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CSUB45S
     */
    public static gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CSUB45S unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CSUB45S) Unmarshaller.unmarshal(gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CSUB45S.class, reader);
    } //-- gov.georgia.dhr.dfcs.sacwis.structs.output.UlIdEvent_ARRAY_CSUB45S unmarshal(java.io.Reader) 
