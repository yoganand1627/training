...
/**
 * ScreeningRefNarr generated by hbm2java
 */
public class ScreeningRefNarr  implements java.io.Serializable {
    ...
    public ScreeningRefNarr() {
    }

	
    public ScreeningRefNarr(Event eventByIdEvent, CapsCase capsCase) {
        this.eventByIdEvent = eventByIdEvent;
        this.capsCase = capsCase;
    }
    public ScreeningRefNarr(Event eventByIdEvent, CapsCase capsCase, byte[] narrative, Integer idDocumentTemplate) {
       this.eventByIdEvent = eventByIdEvent;
       this.capsCase = capsCase;
