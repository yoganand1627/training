...
/**
 * AdoAsstAgreementNarr generated by hbm2java
 */
public class AdoAsstAgreementNarr  implements java.io.Serializable {
    ...
    public AdoAsstAgreementNarr() {
    }

	
    public AdoAsstAgreementNarr(Event event, Stage stage) {
        this.event = event;
        this.stage = stage;
    }
    public AdoAsstAgreementNarr(Event event, Stage stage, Integer idCase, byte[] narrative, Integer idDocumentTable) {
       this.event = event;
       this.stage = stage;
       this.idCase = idCase;
