 ...
 * @author piazzaat
 *         <p/>
 *         Tag used to include content only when web app is running on the tablet. Change History: Date        User
 *         Description --------    --------  -------------------------------------------------- 07/24/05    werlem
 *         SIR 23728 - MPS Phase II Enhancement to add Contact List and Detail to MPS.
 */
public class IfMobileImpact implements Tag {
  ...
  public int doStartTag()
          throws JspException {
    return (PlatformConstants.MOBILE_IMPACT ? EVAL_BODY_INCLUDE : SKIP_BODY);
  }
