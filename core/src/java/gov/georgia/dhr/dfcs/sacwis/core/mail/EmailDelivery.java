...
public class EmailDelivery {
    ...
    public static void main(String args[]) {    
        try {
            ...
            ed.setTo("sriram.subramaniam@accenture.com");
            //ed.setCC("srisubu@gmail.com");
            ed.setFrom("ssubramaniam@dhr.state.ga.us", "Sriram Subramaniam");
            ed.setReplyTo("ssubramaniam@dhr.state.ga.us", "Reply To Me");
            /*ed.setTo("srisubu@gmail.com, srisubu@hotmail.com, ssubramaniam@dhr.state.ga.us");
            ed.setCC("srisubu@yahoo.com");
            ed.setBCC("deepjunk@gmail.com");
            ed.setFrom("samiadith@comcast.net", "Sriram Subu");
            ed.setReplyTo("samiadith@comcast.net", "Reply To Me");*/
            ...
            //ed.setSMTPHost("smtp.comcast.net", "username", "xxxxx");
            ed.setSMTPHost("mail.dhr.state.ga.us", "ssubramaniam", "xxxxxx");
            ed.sendMsg();
