...
/**
 * This exception is thrown when a duplicate record is found in the cache.
 *
 * @author Prem Raghupathy, March 12, 2002
 */

public final class DuplicateRecordFoundException extends ReferenceDataException {
  /**
   * Public Constructor
   *
   ...
   */
  public DuplicateRecordFoundException(String msg, Exception e, int priorityLevel) {
   ...
   * @param priorityLevel - Error priority for logging purposes
   */
  public DuplicateRecordFoundException(String msg, int priorityLevel) {
