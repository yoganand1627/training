...
/**
 * This exception is thrown when the specific value is not found in the cache.
 *
 * @author Prem Raghupathy, March 11, 2002
 */

public final class DataNotFoundException extends ReferenceDataException {
  /**
   * Public Constructor
   *
   ...
   */
  public DataNotFoundException(String msg, Exception e, int priorityLevel) {
   ...
   * @param priorityLevel - Error priority for logging purposes
   */
  public DataNotFoundException(String msg, int priorityLevel) {
